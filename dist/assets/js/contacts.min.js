window.addEventListener("DOMContentLoaded",(()=>{const e=document.querySelector(".preloader");document.body.onload=()=>{const o=localStorage.getItem("langChoiceVisited");e.classList.contains("preloader_active")||(e.classList.add("preloader_active"),localStorage.setItem("langChoiceVisited",!0),document.body.style.overflow="hidden"),"true"===o&&(t.style.display="none",document.body.style.overflow="auto")};const t=document.querySelector(".choice-languages");document.querySelectorAll(".choice-languages__items-link").forEach((e=>{e.addEventListener("click",(()=>{t.classList.add("choice-languages_active"),document.body.style.overflow="auto"}))}));const o=()=>{const e=document.createElement("canvas");return!(!e.getContext||!e.getContext("2d"))&&0===e.toDataURL("image/webp").indexOf("data:image/webp")};o()?document.querySelector(".header").style.backgroundImage="url(../../assets/img/bg/webp/contacts-min.webp)":document.querySelector(".header").style.backgroundImage="url(../../assets/img/bg/contacts-min.png)",o()?document.querySelector(".word").style.backgroundImage="url(../../assets/img/bg/webp/map-min.webp)":document.querySelector(".word").style.backgroundImage="url(../../assets/img/bg/map-min.jpg",document.querySelector(".header").style.backgroundPosition="center";const l=document.querySelector(".menu"),s=document.querySelectorAll(".menu__items"),c=document.querySelector(".hamburger"),a=document.querySelector(".decor_translucent");c.addEventListener("click",(()=>{c.classList.contains("hamburger_active")?(c.classList.remove("hamburger_active"),u.classList.remove("reg-overlay_active"),document.body.style.overflow="auto",l.classList.remove("menu_active"),c&&a.classList.remove("decor_translucent_active")):(c.classList.add("hamburger_active"),u.classList.add("reg-overlay_active"),document.body.style.overflow="hidden",l.classList.add("menu_active"),c&&a.classList.add("decor_translucent_active"))})),s.forEach((e=>{e.addEventListener("click",(()=>{c.classList.remove("hamburger_active"),u.classList.remove("reg-overlay_active"),document.body.style.overflow="auto",l.classList.remove("menu_active"),c&&a.classList.remove("decor_translucent_active")}))}));const r=document.querySelector(".callback"),d=document.querySelector(".button_callback"),n=document.querySelector(".button_callback-form"),i=document.querySelectorAll(".modal-callback__header-close"),u=document.querySelector(".cb-overlay");d.addEventListener("click",(()=>{u.classList.add("cb-overlay_active"),c.style.visibility="hidden",r.classList.add("callback_active"),document.body.style.overflow="hidden",d.classList.add("button_active"),document.addEventListener("keydown",m)}));document.querySelector(".coupon__img").addEventListener("click",(()=>{u.classList.add("cb-overlay_active"),c.style.visibility="hidden",r.classList.add("callback_active"),document.body.style.overflow="hidden",d.classList.add("button_active")})),i.forEach((e=>{e.addEventListener("click",(()=>{u.classList.remove("cb-overlay_active"),c.style.visibility="visible",r.classList.remove("callback_active"),document.body.style.overflow="auto",D.classList.add("coupon_active"),d.classList.remove("button_active")}))}));const m=e=>{"Escape"===e.key&&(u.classList.remove("cb-overlay_active"),c.style.visibility="visible",r.classList.remove("callback_active"),document.body.style.overflow="auto",d.classList.remove("button_active"),D.classList.add("coupon_active"))};document.querySelectorAll(".modal-callback__form-privacy-link").forEach((e=>{e.addEventListener("click",(e=>{e.preventDefault()}))}));const y=document.querySelector(".modal-callback__form"),v=document.getElementById("firstName-callback"),b=document.querySelector(".modal-callback__form-error_firstName"),p=document.getElementById("lastName-callback"),_=document.querySelector(".modal-callback__form-error_lastName"),g=document.getElementById("cities-callback"),k=document.querySelector(".modal-callback__form-error_cities"),S=document.getElementById("couponCode-callback"),h=document.querySelector(".modal-callback__form-error_couponCode"),E=document.getElementById("phoneNumber-callback"),f=document.querySelector(".modal-callback__form-error_phoneNumber");IMask(E,{mask:"+{38\\0}(00)-000-00-00"});y.addEventListener("submit",(e=>{const t=/^[а-яА-Я]{2,}$/.test(v.value)&&""!==v.value.trim();t?(b.style.display="none",v.style.border="1px solid green"):(b.style.display="block",v.style.border="1px solid red");const o=/^[а-яА-Я]{3,}$/.test(p.value)&&""!==p.value.trim();o?(_.style.display="none",p.style.border="1px solid green"):(_.style.display="block",p.style.border="1px solid red");const l=""!==g.value.trim();l?(k.style.display="none",g.style.border="1px solid green"):(k.style.display="block",g.style.border="1px solid red");const s="uber2024"===S.value||""===S.value.trim();s?(h.style.display="none",S.style.border="1px solid green"):(h.style.display="block",S.style.border="1px solid red");const a=/^\+380\((50|66|95|99|63|67|68|96|97|98|39|73|93)\)-\d{3}-\d{2}-\d{2}$/.test(E.value)&&""!==E.value.trim();a?(f.style.display="none",E.style.border="1px solid green"):(f.style.display="block",E.style.border="1px solid red");!1===[t,o,l,s,a].every((e=>e))?(c.style.visibility="hidden",e.preventDefault()):(e.preventDefault(),r.classList.remove("callback_active"),c.style.visibility="visible",u.classList.remove("cb-overlay_active"),document.body.style.overflow="auto",D.style.display="none",localStorage.setItem("couponClosed",!0),d.classList.remove("button_active"),N.classList.add("success_active"),y.reset(),setTimeout((()=>{N.classList.remove("success_active")}),7e3))}));let q=!1;v.addEventListener("input",(()=>{q=/^[а-яА-Я]{2,}$/.test(v.value)&&""!==v.value.trim(),q?(b.style.display="none",v.style.border="1px solid green"):(b.style.display="block",v.style.border="1px solid red"),C()}));let w=!1;p.addEventListener("input",(()=>{w=/^[а-яА-Я]{3,}$/.test(p.value)&&""!==p.value.trim(),w?(_.style.display="none",p.style.border="1px solid green"):(_.style.display="block",p.style.border="1px solid red"),C()}));let x=!1;g.addEventListener("input",(()=>{x=""!==g.value.trim(),x?(k.style.display="none",g.style.border="1px solid green"):(k.style.display="block",g.style.border="1px solid red"),C()}));let I=!1;E.addEventListener("input",(()=>{I=/^\+380\((50|66|95|99|63|67|68|96|97|98|39|73|93)\)-\d{3}-\d{2}-\d{2}$/.test(E.value)&&""!==E.value.trim(),I?(f.style.display="none",E.style.border="1px solid green"):(f.style.display="block",E.style.border="1px solid red"),C()}));const C=()=>{q&&w&&x&&I?n.classList.remove("button_active"):n.classList.add("button_active")};C();const B=document.querySelector(".coupon__close"),D=document.querySelector(".coupon"),T=localStorage.getItem("couponClosed");B.addEventListener("click",(()=>{localStorage.setItem("couponClosed",!0),D.style.display="none"})),"true"===T&&(D.style.display="none");const N=document.querySelector(".success");document.querySelector(".success__close").addEventListener("click",(()=>{N.classList.remove("success_active")}));const $=document.querySelector(".decor");document.onscroll=()=>{window.scrollY>$.offsetTop?a.style.top="0px":a.style.top=""};const M=e=>{e.scrollIntoView({behavior:"smooth"})},P=document.querySelector(".subheader__logo-link"),z=document.getElementById("to-header"),A=document.getElementById("contacts"),O=document.getElementById("geolocation"),V=document.getElementById("to-geolocation");P.addEventListener("click",(e=>{e.preventDefault(),M(z)})),A.addEventListener("click",(e=>{e.preventDefault()})),O.addEventListener("click",(e=>{e.preventDefault(),M(V)}));const U=document.querySelector(".word__link"),Z=document.querySelector(".word__map");U.addEventListener("click",(()=>{Z.classList.toggle("word__map_active"),Z.classList.contains("word__map_active")?U.innerHTML="РАЗВЕРНУТЬ КАРТУ":U.innerHTML="СПРЯТАТЬ КАРТУ"}));let H=L.map("map",{scrollWheelZoom:!1,touchZoom:!0}).setView([50.4501,30.5234],14);H.on("click",(()=>{H.zoomIn()})),H.on("contextmenu",(()=>{H.zoomOut()})),H.zoomControl.setPosition("topright");let j=L.marker([50.4567,30.5198]).addTo(H),R=L.marker([50.4501,30.5234]).addTo(H);j.bindPopup("<b>Главный офис Uber в Киеве</b><br>Адрес: ул. Хрещатик, 1, Киев, 01001<br>Время работы: Пн-Вс, 24/7").openPopup(),R.bindPopup("<b>Филиал UberEats в Киеве</b><br>Адрес: бул. Леси Украинки, 10, Киев, 01034<br>Время работы: Пн-Пт: 10:00 - 22:00, Сб-Вс: 12:00 - 20:00"),L.tileLayer("https://tile.openstreetmap.org/{z}/{x}/{y}.png",{maxZoom:19,attribution:'&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>'}).addTo(H)}));
