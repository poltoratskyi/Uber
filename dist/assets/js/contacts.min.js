window.addEventListener("DOMContentLoaded",(()=>{let e=L.map("map",{scrollWheelZoom:!1,touchZoom:!0}).setView([50.4501,30.5234],14);e.on("click",(()=>{e.zoomIn()})),e.on("contextmenu",(()=>{e.zoomOut()})),e.zoomControl.setPosition("topright");let t=L.marker([50.4567,30.5198]).addTo(e),o=L.marker([50.4501,30.5234]).addTo(e);t.bindPopup("<b>Главный офис Uber в Киеве</b><br>Адрес: ул. Хрещатик, 1, Киев, 01001<br>Время работы: Пн-Вс, 24/7").openPopup(),o.bindPopup("<b>Филиал UberEats в Киеве</b><br>Адрес: бул. Леси Украинки, 10, Киев, 01034<br>Время работы: Пн-Пт: 10:00 - 22:00, Сб-Вс: 12:00 - 20:00"),L.tileLayer("https://tile.openstreetmap.org/{z}/{x}/{y}.png",{maxZoom:19,attribution:'&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>'}).addTo(e),(new WOW).init();const l=document.querySelector(".preloader");document.body.onload=()=>{const e=localStorage.getItem("langChoiceVisited");l.classList.contains("preloader_active")||(l.classList.add("preloader_active"),document.body.style.overflow="hidden"),"true"===e&&(c.style.display="none",document.body.style.overflow="auto")};const c=document.querySelector(".lang-overlay");document.querySelectorAll(".languages-content__menu-item").forEach((e=>{e.addEventListener("click",(()=>{localStorage.setItem("langChoiceVisited",!0),c.classList.add("lang-overlay_active"),document.body.style.overflow="auto"}))}));const s=()=>{const e=document.createElement("canvas");return!(!e.getContext||!e.getContext("2d"))&&0===e.toDataURL("image/webp").indexOf("data:image/webp")};s()?document.querySelector(".header").style.backgroundImage="url(../../assets/img/bg/webp/contacts-min.webp)":document.querySelector(".header").style.backgroundImage="url(../../assets/img/bg/contacts-min.png)",document.querySelector(".header").style.backgroundPosition="center",s()?document.querySelector(".word").style.backgroundImage="url(../../assets/img/bg/webp/map-min.webp)":document.querySelector(".word").style.backgroundImage="url(../../assets/img/bg/map-min.jpg";const a=document.querySelector(".menu"),r=document.querySelectorAll(".menu__items"),n=document.querySelector(".hamburger"),d=document.querySelector(".decor_translucent");n.addEventListener("click",(()=>{n.classList.contains("hamburger_active")?(n.classList.remove("hamburger_active"),v.classList.remove("reg-overlay_active"),document.body.style.overflow="auto",a.classList.remove("menu_active"),n&&d.classList.remove("decor_translucent_active")):(n.classList.add("hamburger_active"),v.classList.add("reg-overlay_active"),document.body.style.overflow="hidden",a.classList.add("menu_active"),n&&d.classList.add("decor_translucent_active"))})),r.forEach((e=>{e.addEventListener("click",(()=>{n.classList.remove("hamburger_active"),v.classList.remove("reg-overlay_active"),document.body.style.overflow="auto",a.classList.remove("menu_active"),n&&d.classList.remove("decor_translucent_active")}))}));const i=document.querySelector(".callback"),u=document.querySelector(".button_callback"),m=document.querySelector(".button_callback-form"),y=document.querySelectorAll(".modal-callback__header-close"),v=document.querySelector(".cb-overlay");u.addEventListener("click",(()=>{v.classList.add("cb-overlay_active"),n.style.visibility="hidden",i.classList.add("callback_active"),document.body.style.overflow="hidden",u.classList.add("button_active"),document.addEventListener("keydown",b)}));document.querySelector(".coupon__img").addEventListener("click",(()=>{v.classList.add("cb-overlay_active"),n.style.visibility="hidden",i.classList.add("callback_active"),document.body.style.overflow="hidden",u.classList.add("button_active")})),y.forEach((e=>{e.addEventListener("click",(()=>{v.classList.remove("cb-overlay_active"),n.style.visibility="visible",i.classList.remove("callback_active"),document.body.style.overflow="auto",N.classList.add("coupon_active"),u.classList.remove("button_active")}))}));const b=e=>{"Escape"===e.key&&(v.classList.remove("cb-overlay_active"),n.style.visibility="visible",i.classList.remove("callback_active"),document.body.style.overflow="auto",u.classList.remove("button_active"),N.classList.add("coupon_active"))};document.querySelectorAll(".modal-callback__form-privacy-link").forEach((e=>{e.addEventListener("click",(e=>{e.preventDefault()}))}));const p=document.querySelector(".modal-callback__form"),_=document.getElementById("firstName-callback"),g=document.querySelector(".modal-callback__form-error_firstName"),k=document.getElementById("lastName-callback"),f=document.querySelector(".modal-callback__form-error_lastName"),E=document.getElementById("cities-callback"),S=document.querySelector(".modal-callback__form-error_cities"),h=document.getElementById("couponCode-callback"),q=document.querySelector(".modal-callback__form-error_couponCode"),w=document.getElementById("phoneNumber-callback"),x=document.querySelector(".modal-callback__form-error_phoneNumber");IMask(w,{mask:"+{38\\0}(00)-000-00-00"});p.addEventListener("submit",(e=>{const t=/^[а-яА-Я]{2,}$/.test(_.value)&&""!==_.value.trim();t?(g.style.display="none",_.style.border="1px solid green"):(g.style.display="block",_.style.border="1px solid red");const o=/^[а-яА-Я]{3,}$/.test(k.value)&&""!==k.value.trim();o?(f.style.display="none",k.style.border="1px solid green"):(f.style.display="block",k.style.border="1px solid red");const l=""!==E.value.trim();l?(S.style.display="none",E.style.border="1px solid green"):(S.style.display="block",E.style.border="1px solid red");const c="uber2024"===h.value||""===h.value.trim();c?(q.style.display="none",h.style.border="1px solid green"):(q.style.display="block",h.style.border="1px solid red");const s=/^\+380\((50|66|95|99|63|67|68|96|97|98|39|73|93)\)-\d{3}-\d{2}-\d{2}$/.test(w.value)&&""!==w.value.trim();s?(x.style.display="none",w.style.border="1px solid green"):(x.style.display="block",w.style.border="1px solid red");!1===[t,o,l,c,s].every((e=>e))?(n.style.visibility="hidden",e.preventDefault()):(e.preventDefault(),i.classList.remove("callback_active"),n.style.visibility="visible",v.classList.remove("cb-overlay_active"),document.body.style.overflow="auto",N.style.display="none",localStorage.setItem("couponClosed",!0),u.classList.remove("button_active"),M.classList.add("success_active"),p.reset(),setTimeout((()=>{M.classList.remove("success_active")}),7e3))}));let I=!1;_.addEventListener("input",(()=>{I=/^[а-яА-Я]{2,}$/.test(_.value)&&""!==_.value.trim(),I?(g.style.display="none",_.style.border="1px solid green"):(g.style.display="block",_.style.border="1px solid red"),T()}));let C=!1;k.addEventListener("input",(()=>{C=/^[а-яА-Я]{3,}$/.test(k.value)&&""!==k.value.trim(),C?(f.style.display="none",k.style.border="1px solid green"):(f.style.display="block",k.style.border="1px solid red"),T()}));let D=!1;E.addEventListener("input",(()=>{D=""!==E.value.trim(),D?(S.style.display="none",E.style.border="1px solid green"):(S.style.display="block",E.style.border="1px solid red"),T()}));let B=!1;w.addEventListener("input",(()=>{B=/^\+380\((50|66|95|99|63|67|68|96|97|98|39|73|93)\)-\d{3}-\d{2}-\d{2}$/.test(w.value)&&""!==w.value.trim(),B?(x.style.display="none",w.style.border="1px solid green"):(x.style.display="block",w.style.border="1px solid red"),T()}));const T=()=>{I&&C&&D&&B?m.classList.remove("button_active"):m.classList.add("button_active")};T();const A=document.querySelector(".coupon__close"),N=document.querySelector(".coupon"),$=localStorage.getItem("couponClosed");A.addEventListener("click",(()=>{localStorage.setItem("couponClosed",!0),N.style.display="none"})),"true"===$&&(N.style.display="none");const M=document.querySelector(".success");document.querySelector(".success__close").addEventListener("click",(()=>{M.classList.remove("success_active")}));const O=document.querySelector(".decor");document.onscroll=()=>{window.scrollY>O.offsetTop?d.style.top="0px":d.style.top=""};const P=document.getElementById("contacts"),z=document.getElementById("contacts-header"),V=document.querySelector(".subheader__logo-link"),U=document.getElementById("contacts-geolocation"),W=document.getElementById("contacts-geolocation-link"),Z=document.getElementById("contacts-footer-geolocation"),H=e=>{e.scrollIntoView({behavior:"smooth"})};P.addEventListener("click",(e=>{e.preventDefault()})),V.addEventListener("click",(e=>{e.preventDefault(),H(z)})),U.addEventListener("click",(e=>{e.preventDefault(),H(W)})),Z.addEventListener("click",(e=>{e.preventDefault(),H(W)}));const j=document.querySelector(".word__link"),R=document.querySelector(".word__map");j.addEventListener("click",(()=>{R.classList.toggle("word__map_active"),R.classList.contains("word__map_active")?j.innerHTML="РАЗВЕРНУТЬ КАРТУ":j.innerHTML="СПРЯТАТЬ КАРТУ"}));document.querySelectorAll(".footer__menu-support-link").forEach((e=>{e.addEventListener("click",(e=>{e.preventDefault()}))}));document.querySelectorAll(".footer__menu-language-link").forEach((e=>{e.addEventListener("click",(e=>{e.preventDefault()}))}))}));
