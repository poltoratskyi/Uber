window.addEventListener("DOMContentLoaded",(()=>{let e=L.map("map",{scrollWheelZoom:!1,touchZoom:!0}).setView([50.4501,30.5234],14);e.on("click",(()=>{e.zoomIn()})),e.on("contextmenu",(()=>{e.zoomOut()})),e.zoomControl.setPosition("topright");let t=L.marker([50.4567,30.5198]).addTo(e),o=L.marker([50.4501,30.5234]).addTo(e);t.bindPopup("<b>Главный офис Uber в Киеве</b><br>Адрес: ул. Хрещатик, 1, Киев, 01001<br>Время работы: Пн-Вс, 24/7").openPopup(),o.bindPopup("<b>Филиал UberEats в Киеве</b><br>Адрес: бул. Леси Украинки, 10, Киев, 01034<br>Время работы: Пн-Пт: 10:00 - 22:00, Сб-Вс: 12:00 - 20:00"),L.tileLayer("https://tile.openstreetmap.org/{z}/{x}/{y}.png",{maxZoom:19,attribution:'&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>'}).addTo(e),(new WOW).init(),document.body.onload=()=>{const e=document.querySelector(".preloader"),t=document.querySelector(".lang-overlay");document.querySelectorAll(".languages-content__menu-item").forEach((e=>{e.addEventListener("click",(e=>{e.preventDefault(),localStorage.setItem("langChoiceVisited",!0),t.classList.add("lang-overlay_active"),document.body.style.overflow="auto"}))}));const o=localStorage.getItem("langChoiceVisited");e.classList.contains("preloader_active")||(e.classList.add("preloader_active"),document.body.style.overflow="hidden"),"true"===o&&(t.style.display="none",document.body.style.overflow="auto")};const l=()=>{const e=document.createElement("canvas");return!(!e.getContext||!e.getContext("2d"))&&0===e.toDataURL("image/webp").indexOf("data:image/webp")};l()?document.querySelector(".header").style.backgroundImage="url(../../assets/img/bg/webp/contacts-min.webp)":document.querySelector(".header").style.backgroundImage="url(../../assets/img/bg/contacts-min.png)",document.querySelector(".header").style.backgroundPosition="center",l()?document.querySelector(".word").style.backgroundImage="url(../../assets/img/bg/webp/map-min.webp)":document.querySelector(".word").style.backgroundImage="url(../../assets/img/bg/map-min.jpg";const c=document.querySelector(".menu"),s=document.querySelectorAll(".menu__items"),a=document.querySelector(".hamburger"),r=document.querySelector(".decor_translucent");a.addEventListener("click",(()=>{a.classList.contains("hamburger_active")?(a.classList.remove("hamburger_active"),m.classList.remove("reg-overlay_active"),document.body.style.overflow="auto",c.classList.remove("menu_active"),a&&r.classList.remove("decor_translucent_active")):(a.classList.add("hamburger_active"),m.classList.add("reg-overlay_active"),document.body.style.overflow="hidden",c.classList.add("menu_active"),a&&r.classList.add("decor_translucent_active"))})),s.forEach((e=>{e.addEventListener("click",(()=>{a.classList.remove("hamburger_active"),m.classList.remove("reg-overlay_active"),document.body.style.overflow="auto",c.classList.remove("menu_active"),a&&r.classList.remove("decor_translucent_active")}))}));const n=document.querySelector(".callback"),d=document.querySelector(".button_callback"),i=document.querySelector(".button_callback-form"),u=document.querySelectorAll(".modal-callback__header-close"),m=document.querySelector(".cb-overlay");d.addEventListener("click",(()=>{m.classList.add("cb-overlay_active"),a.style.visibility="hidden",n.classList.add("callback_active"),document.body.style.overflow="hidden",d.classList.add("button_active"),document.addEventListener("keydown",y)}));document.querySelector(".coupon__img").addEventListener("click",(()=>{m.classList.add("cb-overlay_active"),a.style.visibility="hidden",n.classList.add("callback_active"),document.body.style.overflow="hidden",d.classList.add("button_active")})),u.forEach((e=>{e.addEventListener("click",(()=>{m.classList.remove("cb-overlay_active"),a.style.visibility="visible",n.classList.remove("callback_active"),document.body.style.overflow="auto",T.classList.add("coupon_active"),d.classList.remove("button_active")}))}));const y=e=>{"Escape"===e.key&&(m.classList.remove("cb-overlay_active"),a.style.visibility="visible",n.classList.remove("callback_active"),document.body.style.overflow="auto",d.classList.remove("button_active"),T.classList.add("coupon_active"))};document.querySelectorAll(".modal-callback__form-privacy-link").forEach((e=>{e.addEventListener("click",(e=>{e.preventDefault()}))}));const v=document.querySelector(".modal-callback__form"),b=document.getElementById("firstName-callback"),p=document.querySelector(".modal-callback__form-error_firstName"),_=document.getElementById("lastName-callback"),g=document.querySelector(".modal-callback__form-error_lastName"),k=document.getElementById("cities-callback"),f=document.querySelector(".modal-callback__form-error_cities"),E=document.getElementById("couponCode-callback"),S=document.querySelector(".modal-callback__form-error_couponCode"),h=document.getElementById("phoneNumber-callback"),q=document.querySelector(".modal-callback__form-error_phoneNumber");IMask(h,{mask:"+{38\\0}(00)-000-00-00"});v.addEventListener("submit",(e=>{const t=/^[а-яА-Я]{2,}$/.test(b.value)&&""!==b.value.trim();t?(p.style.display="none",b.style.border="1px solid green"):(p.style.display="block",b.style.border="1px solid red");const o=/^[а-яА-Я]{3,}$/.test(_.value)&&""!==_.value.trim();o?(g.style.display="none",_.style.border="1px solid green"):(g.style.display="block",_.style.border="1px solid red");const l=""!==k.value.trim();l?(f.style.display="none",k.style.border="1px solid green"):(f.style.display="block",k.style.border="1px solid red");const c="uber2024"===E.value||""===E.value.trim();c?(S.style.display="none",E.style.border="1px solid green"):(S.style.display="block",E.style.border="1px solid red");const s=/^\+380\((50|66|95|99|63|67|68|96|97|98|39|73|93)\)-\d{3}-\d{2}-\d{2}$/.test(h.value)&&""!==h.value.trim();s?(q.style.display="none",h.style.border="1px solid green"):(q.style.display="block",h.style.border="1px solid red");!1===[t,o,l,c,s].every((e=>e))?(a.style.visibility="hidden",e.preventDefault()):(e.preventDefault(),n.classList.remove("callback_active"),a.style.visibility="visible",m.classList.remove("cb-overlay_active"),document.body.style.overflow="auto",T.style.display="none",localStorage.setItem("couponClosed",!0),d.classList.remove("button_active"),N.classList.add("success_active"),v.reset(),setTimeout((()=>{N.classList.remove("success_active")}),7e3))}));let w=!1;b.addEventListener("input",(()=>{w=/^[а-яА-Я]{2,}$/.test(b.value)&&""!==b.value.trim(),w?(p.style.display="none",b.style.border="1px solid green"):(p.style.display="block",b.style.border="1px solid red"),C()}));let x=!1;_.addEventListener("input",(()=>{x=/^[а-яА-Я]{3,}$/.test(_.value)&&""!==_.value.trim(),x?(g.style.display="none",_.style.border="1px solid green"):(g.style.display="block",_.style.border="1px solid red"),C()}));let I=!1;k.addEventListener("input",(()=>{I=""!==k.value.trim(),I?(f.style.display="none",k.style.border="1px solid green"):(f.style.display="block",k.style.border="1px solid red"),C()}));let D=!1;h.addEventListener("input",(()=>{D=/^\+380\((50|66|95|99|63|67|68|96|97|98|39|73|93)\)-\d{3}-\d{2}-\d{2}$/.test(h.value)&&""!==h.value.trim(),D?(q.style.display="none",h.style.border="1px solid green"):(q.style.display="block",h.style.border="1px solid red"),C()}));const C=()=>{w&&x&&I&&D?i.classList.remove("button_active"):i.classList.add("button_active")};C();const B=document.querySelector(".coupon__close"),T=document.querySelector(".coupon"),A=localStorage.getItem("couponClosed");B.addEventListener("click",(()=>{localStorage.setItem("couponClosed",!0),T.style.display="none"})),"true"===A&&(T.style.display="none");const N=document.querySelector(".success");document.querySelector(".success__close").addEventListener("click",(()=>{N.classList.remove("success_active")}));const $=document.querySelector(".decor");document.onscroll=()=>{window.scrollY>$.offsetTop?r.style.top="0px":r.style.top=""};const M=document.getElementById("contacts"),O=document.getElementById("contacts-header"),P=document.querySelector(".subheader__logo-link"),z=document.getElementById("contacts-geolocation"),V=document.getElementById("contacts-geolocation-link"),U=document.getElementById("contacts-footer-geolocation"),W=e=>{e.scrollIntoView({behavior:"smooth"})};M.addEventListener("click",(e=>{e.preventDefault()})),P.addEventListener("click",(e=>{e.preventDefault(),W(O)})),z.addEventListener("click",(e=>{e.preventDefault(),W(V)})),U.addEventListener("click",(e=>{e.preventDefault(),W(V)}));const Z=document.querySelector(".word__link"),H=document.querySelector(".word__map");Z.addEventListener("click",(()=>{H.classList.toggle("word__map_active"),H.classList.contains("word__map_active")?Z.innerHTML="РАЗВЕРНУТЬ КАРТУ":Z.innerHTML="СПРЯТАТЬ КАРТУ"}));document.querySelectorAll(".footer__menu-support-link").forEach((e=>{e.addEventListener("click",(e=>{e.preventDefault()}))}));document.querySelectorAll(".footer__menu-language-link").forEach((e=>{e.addEventListener("click",(e=>{e.preventDefault()}))}))}));
