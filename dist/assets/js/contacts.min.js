window.addEventListener("DOMContentLoaded",(()=>{const e=()=>{const e=document.createElement("canvas");return!(!e.getContext||!e.getContext("2d"))&&0===e.toDataURL("image/webp").indexOf("data:image/webp")};e()?document.querySelector(".header").style.backgroundImage="url(../../assets/img/bg/webp/contacts-min.webp)":document.querySelector(".header").style.backgroundImage="url(../../assets/img/bg/contacts-min.png)",e()?document.querySelector(".word").style.backgroundImage="url(../../assets/img/bg/webp/map-min.webp)":document.querySelector(".word").style.backgroundImage="url(../../assets/img/bg/map-min.jpg",document.querySelector(".header").style.backgroundPosition="center";const t=document.querySelector(".menu"),o=document.querySelectorAll(".menu__items"),l=document.querySelector(".hamburger"),s=document.querySelector(".decor_translucent");l.addEventListener("click",(()=>{l.classList.contains("hamburger_active")?(l.classList.remove("hamburger_active"),n.classList.remove("reg-overlay_active"),document.body.style.overflow="auto",t.classList.remove("menu_active"),l&&s.classList.remove("decor_translucent_active")):(l.classList.add("hamburger_active"),n.classList.add("reg-overlay_active"),document.body.style.overflow="hidden",t.classList.add("menu_active"),l&&s.classList.add("decor_translucent_active"))})),o.forEach((e=>{e.addEventListener("click",(()=>{l.classList.remove("hamburger_active"),n.classList.remove("reg-overlay_active"),document.body.style.overflow="auto",t.classList.remove("menu_active"),l&&s.classList.remove("decor_translucent_active")}))}));const c=document.querySelector(".callback"),r=document.querySelector(".button_callback"),a=document.querySelector(".button_callback-form"),d=document.querySelectorAll(".modal-callback__header-close"),n=document.querySelector(".cb-overlay");r.addEventListener("click",(()=>{n.classList.add("cb-overlay_active"),l.style.visibility="hidden",c.classList.add("callback_active"),document.body.style.overflow="hidden",r.classList.add("button_active"),document.addEventListener("keydown",i)}));document.querySelector(".coupon__img").addEventListener("click",(()=>{n.classList.add("cb-overlay_active"),l.style.visibility="hidden",c.classList.add("callback_active"),document.body.style.overflow="hidden",r.classList.add("button_active")})),d.forEach((e=>{e.addEventListener("click",(()=>{n.classList.remove("cb-overlay_active"),l.style.visibility="visible",c.classList.remove("callback_active"),document.body.style.overflow="auto",B.classList.add("coupon_active"),r.classList.remove("button_active")}))}));const i=e=>{"Escape"===e.key&&(n.classList.remove("cb-overlay_active"),l.style.visibility="visible",c.classList.remove("callback_active"),document.body.style.overflow="auto",r.classList.remove("button_active"),B.classList.add("coupon_active"))};document.querySelectorAll(".modal-callback__form-privacy-link").forEach((e=>{e.addEventListener("click",(e=>{e.preventDefault()}))}));const u=document.querySelector(".modal-callback__form"),m=document.getElementById("firstName-callback"),y=document.querySelector(".modal-callback__form-error_firstName"),v=document.getElementById("lastName-callback"),b=document.querySelector(".modal-callback__form-error_lastName"),p=document.getElementById("cities-callback"),_=document.querySelector(".modal-callback__form-error_cities"),g=document.getElementById("couponCode-callback"),k=document.querySelector(".modal-callback__form-error_couponCode"),E=document.getElementById("phoneNumber-callback"),f=document.querySelector(".modal-callback__form-error_phoneNumber");IMask(E,{mask:"+{38\\0}(00)-000-00-00"});u.addEventListener("submit",(e=>{const t=/^[а-яА-Я]{2,}$/.test(m.value)&&""!==m.value.trim();t?(y.style.display="none",m.style.border="1px solid green"):(y.style.display="block",m.style.border="1px solid red");const o=/^[а-яА-Я]{3,}$/.test(v.value)&&""!==v.value.trim();o?(b.style.display="none",v.style.border="1px solid green"):(b.style.display="block",v.style.border="1px solid red");const s=""!==p.value.trim();s?(_.style.display="none",p.style.border="1px solid green"):(_.style.display="block",p.style.border="1px solid red");const a="uber2024"===g.value||""===g.value.trim();a?(k.style.display="none",g.style.border="1px solid green"):(k.style.display="block",g.style.border="1px solid red");const d=/^\+380\((50|66|95|99|63|67|68|96|97|98|39|73|93)\)-\d{3}-\d{2}-\d{2}$/.test(E.value)&&""!==E.value.trim();d?(f.style.display="none",E.style.border="1px solid green"):(f.style.display="block",E.style.border="1px solid red");!1===[t,o,s,a,d].every((e=>e))?(l.style.visibility="hidden",e.preventDefault()):(e.preventDefault(),c.classList.remove("callback_active"),l.style.visibility="visible",n.classList.remove("cb-overlay_active"),document.body.style.overflow="auto",B.style.display="none",r.classList.remove("button_active"),D.classList.add("success_active"),u.reset(),setTimeout((()=>{D.classList.remove("success_active")}),7e3))}));let h=!1;m.addEventListener("input",(()=>{h=/^[а-яА-Я]{2,}$/.test(m.value)&&""!==m.value.trim(),h?(y.style.display="none",m.style.border="1px solid green"):(y.style.display="block",m.style.border="1px solid red"),x()}));let S=!1;v.addEventListener("input",(()=>{S=/^[а-яА-Я]{3,}$/.test(v.value)&&""!==v.value.trim(),S?(b.style.display="none",v.style.border="1px solid green"):(b.style.display="block",v.style.border="1px solid red"),x()}));let q=!1;p.addEventListener("input",(()=>{q=""!==p.value.trim(),q?(_.style.display="none",p.style.border="1px solid green"):(_.style.display="block",p.style.border="1px solid red"),x()}));let w=!1;E.addEventListener("input",(()=>{w=/^\+380\((50|66|95|99|63|67|68|96|97|98|39|73|93)\)-\d{3}-\d{2}-\d{2}$/.test(E.value)&&""!==E.value.trim(),w?(f.style.display="none",E.style.border="1px solid green"):(f.style.display="block",E.style.border="1px solid red"),x()}));const x=()=>{h&&S&&q&&w?a.classList.remove("button_active"):a.classList.add("button_active")};x();const I=document.querySelector(".coupon__close"),B=document.querySelector(".coupon");I.addEventListener("click",(()=>{B.style.display="none"}));const D=document.querySelector(".success");document.querySelector(".success__close").addEventListener("click",(()=>{D.classList.remove("success_active")}));const T=document.querySelector(".decor");document.onscroll=()=>{window.scrollY>T.offsetTop?s.style.top="0px":s.style.top=""};const C=e=>{e.scrollIntoView({behavior:"smooth"})},N=document.querySelector(".subheader__logo-link"),$=document.getElementById("to-header"),M=document.getElementById("contacts"),P=document.getElementById("geolocation"),z=document.getElementById("to-geolocation");N.addEventListener("click",(e=>{e.preventDefault(),C($)})),M.addEventListener("click",(e=>{e.preventDefault()})),P.addEventListener("click",(e=>{e.preventDefault(),C(z)}));const O=document.querySelector(".word__link"),A=document.querySelector(".word__map");O.addEventListener("click",(()=>{A.classList.toggle("word__map_active"),A.classList.contains("word__map_active")?O.innerHTML="РАЗВЕРНУТЬ КАРТУ":O.innerHTML="СПРЯТАТЬ КАРТУ"}));let U=L.map("map",{scrollWheelZoom:!1,touchZoom:!0}).setView([50.4501,30.5234],14);U.on("click",(()=>{U.zoomIn()})),U.on("contextmenu",(()=>{U.zoomOut()})),U.zoomControl.setPosition("topright");let Z=L.marker([50.4567,30.5198]).addTo(U),H=L.marker([50.4501,30.5234]).addTo(U);Z.bindPopup("<b>Главный офис Uber в Киеве</b><br>Адрес: ул. Хрещатик, 1, Киев, 01001<br>Время работы: Пн-Вс, 24/7").openPopup(),H.bindPopup("<b>Филиал UberEats в Киеве</b><br>Адрес: бул. Леси Украинки, 10, Киев, 01034<br>Время работы: Пн-Пт: 10:00 - 22:00, Сб-Вс: 12:00 - 20:00"),L.tileLayer("https://tile.openstreetmap.org/{z}/{x}/{y}.png",{maxZoom:19,attribution:'&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>'}).addTo(U)}));
