window.addEventListener("DOMContentLoaded",(()=>{let e=L.map("map",{scrollWheelZoom:!1,touchZoom:!0}).setView([49.0266,31.4832],6);e.on("click",(()=>{e.zoomIn()})),e.on("contextmenu",(()=>{e.zoomOut()})),e.zoomControl.setPosition("topright");let t=L.marker([50.4567,30.5198]).addTo(e),o=L.marker([50.4501,30.5234]).addTo(e),l=L.marker([49.8397,24.0297]).addTo(e),r=L.marker([48.9226,24.7111]).addTo(e),s=L.marker([48.5092,32.2623]).addTo(e),i=L.marker([49.8398,24.0297]).addTo(e),c=L.marker([48.5126,35.0342]).addTo(e),a=L.marker([49.9808,36.2527]).addTo(e),n=L.marker([46.4775,30.7326]).addTo(e),d=L.marker([49.556,25.5906]).addTo(e),u=L.marker([50.8333,34.4844]).addTo(e);t.bindPopup("<b>Главный офис Uber в Киеве</b><br>Адрес: ул. Хрещатик, 1, Киев, 01001<br>Время работы: Пн-Вс, 24/7").openPopup(),o.bindPopup("<b>Филиал UberEats в Киеве</b><br>Адрес: бул. Леси Украинки, 10, Киев, 01034<br>Время работы: Пн-Пт: 10:00 - 22:00, Сб-Вс: 12:00 - 20:00"),l.bindPopup("<b>Филиал  Uber Green в Львове</b><br>Адрес: просп. Свободы, 12, Львов, 79000<br>Время работы: Пн-Вс: 9:00 - 21:00"),r.bindPopup("<b>Филиал Uber Freight в Ивано-Франковске</b><br>Адрес: вул. Грушевського, 7, Ивано-Франковск, 76000<br>Время работы: Пн-Пт: 9:00 - 20:00, Сб: 10:00 - 18:00"),s.bindPopup("<b>Филиал Uber Health в Кропивницком</b><br>Адрес: вул. Київська, 17, Кропивницкий, 25006<br>Время работы: Пн-Вс: 10:00 - 19:00"),i.bindPopup("<b>Филиал Uber в Тернополе</b><br>Адрес: вул. Чорновола, 3, Тернополь, 46001<br>Время работы: Пн-Пт: 9:00 - 18:00"),c.bindPopup("<b>Филиал Uber for Business в Днепре</b><br>Адрес: просп. Слобожанський, 16, Днепр, 49000<br>Время работы: Пн-Вс: 10:00 - 20:00"),a.bindPopup("<b>Филиал Uber Elevate в Харькове</b><br>Адрес: просп. Науки, 24, Харьков, 61000<br>Время работы: Пн-Пт: 9:00 - 21:00, Сб-Вс: 10:00 - 18:00"),n.bindPopup("<b>Филиал Uber Jump в Одессе</b><br>Адрес: вул. Катерининська, 1, Одесса, 65000<br>Время работы: Пн-Вс: 10:00 - 19:00"),d.bindPopup("<b>Филиал  Uber ATG (Advanced Technologies Group) в Хмельницком</b><br>Адрес: вул. Проскурівська, 13, Хмельницкий, 29000<br>Время работы: Пн-Пт: 9:00 - 20:00, Сб: 10:00 - 18:00"),u.bindPopup("<b>Филиал  Uber Air в Полтаве</b><br>Адрес: вул. Шевченка, 23, Полтава, 36000<br>Время работы: Пн-Вс: 10:00 - 19:00"),L.tileLayer("https://tile.openstreetmap.org/{z}/{x}/{y}.png",{maxZoom:19,attribution:'&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>'}).addTo(e),(new WOW).init();const m=document.querySelector(".preloader");document.body.onload=()=>{const e=localStorage.getItem("langChoiceVisited");m.classList.contains("preloader_active")||(m.classList.add("preloader_active"),document.body.style.overflow="hidden"),"true"===e&&(y.style.display="none",document.body.style.overflow="auto")};const y=document.querySelector(".lang-overlay");document.querySelectorAll(".languages-content__menu-item").forEach((e=>{e.addEventListener("click",(()=>{localStorage.setItem("langChoiceVisited",!0),y.classList.add("lang-overlay_active"),document.body.style.overflow="auto"}))}));const b=()=>{const e=document.createElement("canvas");return!(!e.getContext||!e.getContext("2d"))&&0===e.toDataURL("image/webp").indexOf("data:image/webp")};b()?document.querySelector(".header").style.backgroundImage="url(assets/img/bg/webp/main_bg-min.webp)":document.querySelector(".header").style.backgroundImage="url(assets/img/bg/main_bg-min.jpg)",b()?document.querySelector(".mobile-block__decor_item-one").style.backgroundImage="url(assets/img/bg/webp/mobile_screen_1-min.webp)":document.querySelector(".mobile-block__decor_item-one").style.backgroundImage="url(assets/img/bg/mobile_screen_1-min.jpg)",b()?document.querySelector(".mobile-block__decor_item-two").style.backgroundImage="url(assets/img/bg/webp/mobile_screen_2-min.webp)":document.querySelector(".mobile-block__decor_item-two").style.backgroundImage="url(assets/img/bg/mobile_screen_2-min.jpg)",b()?document.querySelector(".mobile-block__decor_item-three").style.backgroundImage="url(assets/img/bg/webp/mobile_screen_3-min.webp)":document.querySelector(".mobile-block__decor_item-three").style.backgroundImage="url(assets/img/bg/mobile_screen_3-min.jpg)",b()?document.querySelector(".mobile-block__decor_item-four").style.backgroundImage="url(assets/img/bg/webp/mobile_screen_4-min.webp)":document.querySelector(".mobile-block__decor_item-four").style.backgroundImage="url(assets/img/bg/mobile_screen_4-min.jpg)",b()?document.querySelector(".mobile-block__decor_item-five").style.backgroundImage="url(assets/img/bg/webp/mobile_screen_5-min.webp)":document.querySelector(".mobile-block__decor_item-five").style.backgroundImage="url(assets/img/bg/mobile_screen_5-min.jpg)",b()?document.querySelector(".mobile-block__decor_item-six").style.backgroundImage="url(assets/img/bg/webp/mobile_screen_6-min.webp)":document.querySelector(".mobile-block__decor_item-six").style.backgroundImage="url(assets/img/bg/mobile_screen_6-min.jpg)",b()?document.querySelector(".word").style.backgroundImage="url(assets/img/bg/webp/map-min.webp)":document.querySelector(".word").style.backgroundImage="url(assets/img/bg/map-min.jpg";const v=document.querySelector(".menu"),_=document.querySelectorAll(".menu__items"),p=document.querySelector(".hamburger"),g=document.querySelector(".decor_translucent");p.addEventListener("click",(()=>{p.classList.contains("hamburger_active")?(p.classList.remove("hamburger_active"),h.classList.remove("reg-overlay_active"),document.body.style.overflow="auto",v.classList.remove("menu_active"),p&&g.classList.remove("decor_translucent_active")):(p.classList.add("hamburger_active"),h.classList.add("reg-overlay_active"),document.body.style.overflow="hidden",v.classList.add("menu_active"),p&&g.classList.add("decor_translucent_active"))})),_.forEach((e=>{e.addEventListener("click",(()=>{p.classList.remove("hamburger_active"),h.classList.remove("reg-overlay_active"),document.body.style.overflow="auto",v.classList.remove("menu_active"),p&&g.classList.remove("decor_translucent_active")}))}));document.querySelectorAll(".mobile-block__wrapper").forEach((e=>{const t=e.querySelector(".mobile-block__image"),o=e.querySelector(".mobile-block__title"),l=e.querySelector(".mobile-block__hidden-title");t.addEventListener("click",(()=>{t&&t.classList.toggle("mobile-block__image_active"),o&&o.classList.toggle("mobile-block__title_active"),l&&l.classList.toggle("mobile-block__hidden-title_active")}))}));const k=document.querySelector(".registration"),E=document.querySelector(".button_registration"),f=document.querySelector(".button_registration-form"),S=document.querySelectorAll(".modal-registration__header-close"),q=document.querySelector(".button-advertising"),h=document.querySelector(".reg-overlay");E.addEventListener("click",(()=>{h.classList.add("reg-overlay_active"),p.style.visibility="hidden",k.classList.add("registration_active"),document.body.style.overflow="hidden",E.classList.add("button_active"),ye.classList.remove("advertising_active"),document.addEventListener("keydown",w)})),q.addEventListener("click",(()=>{h.classList.add("reg-overlay_active"),p.style.visibility="hidden",k.classList.add("registration_active"),document.body.style.overflow="hidden",E.classList.add("button_active"),ye.classList.remove("advertising_active"),document.addEventListener("keydown",w)})),S.forEach((e=>{e.addEventListener("click",(()=>{h.classList.remove("reg-overlay_active"),p.style.visibility="visible",k.classList.remove("registration_active"),document.body.style.overflow="auto",E.classList.remove("button_active")}))}));const w=e=>{"Escape"===e.key&&(h.classList.remove("reg-overlay_active"),p.style.visibility="visible",k.classList.remove("registration_active"),document.body.style.overflow="auto",E.classList.remove("button_active"))},I=document.querySelector(".modal-registration__form"),x=document.getElementById("firstName-registration"),B=document.querySelector(".modal-registration__form-error_firstName"),D=document.getElementById("lastName-registration"),T=document.querySelector(".modal-registration__form-error_lastName"),A=document.getElementById("cities-registration"),C=document.querySelector(".modal-registration__form-error_cities"),U=document.getElementById("email-registration"),$=document.querySelector(".modal-registration__form-error_email"),P=document.getElementById("phoneNumber-registration"),N=document.querySelector(".modal-registration__form-error_phoneNumber");IMask(P,{mask:"+{38\\0}(00)-000-00-00"});I.addEventListener("submit",(e=>{const t=/^[а-яА-Я]{2,}$/.test(x.value)&&""!==x.value.trim();t?(B.style.display="none",x.style.border="1px solid green"):(B.style.display="block",x.style.border="1px solid red");const o=/^[а-яА-Я]{3,}$/.test(D.value)&&""!==D.value.trim();o?(T.style.display="none",D.style.border="1px solid green"):(T.style.display="block",D.style.border="1px solid red");const l=""!==A.value.trim();l?(C.style.display="none",A.style.border="1px solid green"):(C.style.display="block",A.style.border="1px solid red");const r=/^[a-zA-Z0-9._%+-]+@(gmail\.com|yahoo\.com|outlook\.com|hotmail\.com|yandex\.ru)$/i.test(U.value)&&""!==U.value.trim();r?($.style.display="none",U.style.border="1px solid green"):($.style.display="block",U.style.border="1px solid red");const s=/^\+380\((50|66|95|99|63|67|68|96|97|98|39|73|93)\)-\d{3}-\d{2}-\d{2}$/.test(P.value)&&""!==P.value.trim();s?(N.style.display="none",P.style.border="1px solid green"):(N.style.display="block",P.style.border="1px solid red");!1===[t,o,l,r,s].every((e=>e))?(p.style.visibility="hidden",e.preventDefault()):(e.preventDefault(),k.classList.remove("registration_active"),p.style.visibility="visible",h.classList.remove("reg-overlay_active"),document.body.style.overflow="auto",ye.style.display="none",localStorage.setItem("advertisingClosed",!0),E.classList.remove("button_active"),ge.classList.add("success_active"),I.reset(),setTimeout((()=>{ge.classList.remove("success_active")}),7e3))}));let j=!1;x.addEventListener("input",(()=>{j=/^[а-яА-Я]{2,}$/.test(x.value)&&""!==x.value.trim(),j?(B.style.display="none",x.style.border="1px solid green"):(B.style.display="block",x.style.border="1px solid red"),V()}));let z=!1;D.addEventListener("input",(()=>{z=/^[а-яА-Я]{3,}$/.test(D.value)&&""!==D.value.trim(),z?(T.style.display="none",D.style.border="1px solid green"):(T.style.display="block",D.style.border="1px solid red"),V()}));let M=!1;A.addEventListener("input",(()=>{M=""!==A.value.trim(),M?(C.style.display="none",A.style.border="1px solid green"):(C.style.display="block",A.style.border="1px solid red"),V()}));let O=!1;P.addEventListener("input",(()=>{O=/^\+380\((50|66|95|99|63|67|68|96|97|98|39|73|93)\)-\d{3}-\d{2}-\d{2}$/.test(P.value)&&""!==P.value.trim(),O?(N.style.display="none",P.style.border="1px solid green"):(N.style.display="block",P.style.border="1px solid red"),V()}));let Z=!1;U.addEventListener("input",(()=>{Z=/^[a-zA-Z0-9._%+-]+@(gmail\.com|yahoo\.com|outlook\.com|hotmail\.com|yandex\.ru)$/i.test(U.value)&&""!==U.value.trim(),Z?($.style.display="none",U.style.border="1px solid green"):($.style.display="block",U.style.border="1px solid red"),V()}));const V=()=>{j&&z&&M&&O&&Z?f.classList.remove("button_active"):f.classList.add("button_active")};V();const G=document.querySelector(".callback"),H=document.querySelector(".button_callback"),R=document.querySelector(".button_callback-form"),W=document.querySelectorAll(".modal-callback__header-close"),F=document.querySelector(".cb-overlay");H.addEventListener("click",(()=>{F.classList.add("cb-overlay_active"),p.style.visibility="hidden",G.classList.add("callback_active"),document.body.style.overflow="hidden",H.classList.add("button_active"),document.addEventListener("keydown",J)}));document.querySelector(".coupon__img").addEventListener("click",(()=>{F.classList.add("cb-overlay_active"),p.style.visibility="hidden",G.classList.add("callback_active"),document.body.style.overflow="hidden",H.classList.add("button_active")})),W.forEach((e=>{e.addEventListener("click",(()=>{F.classList.remove("cb-overlay_active"),p.style.visibility="visible",G.classList.remove("callback_active"),document.body.style.overflow="auto",_e.classList.add("coupon_active"),H.classList.remove("button_active")}))}));const J=e=>{"Escape"===e.key&&(F.classList.remove("cb-overlay_active"),p.style.visibility="visible",G.classList.remove("callback_active"),document.body.style.overflow="auto",H.classList.remove("button_active"),_e.classList.add("coupon_active"))};document.querySelectorAll(".modal-callback__form-privacy-link").forEach((e=>{e.addEventListener("click",(e=>{e.preventDefault()}))}));const Y=document.querySelector(".modal-callback__form"),K=document.getElementById("firstName-callback"),Q=document.querySelector(".modal-callback__form-error_firstName"),X=document.getElementById("lastName-callback"),ee=document.querySelector(".modal-callback__form-error_lastName"),te=document.getElementById("cities-callback"),oe=document.querySelector(".modal-callback__form-error_cities"),le=document.getElementById("couponCode-callback"),re=document.querySelector(".modal-callback__form-error_couponCode"),se=document.getElementById("phoneNumber-callback"),ie=document.querySelector(".modal-callback__form-error_phoneNumber");IMask(se,{mask:"+{38\\0}(00)-000-00-00"});Y.addEventListener("submit",(e=>{const t=/^[а-яА-Я]{2,}$/.test(K.value)&&""!==K.value.trim();t?(Q.style.display="none",K.style.border="1px solid green"):(Q.style.display="block",K.style.border="1px solid red");const o=/^[а-яА-Я]{3,}$/.test(X.value)&&""!==X.value.trim();o?(ee.style.display="none",X.style.border="1px solid green"):(ee.style.display="block",X.style.border="1px solid red");const l=""!==te.value.trim();l?(oe.style.display="none",te.style.border="1px solid green"):(oe.style.display="block",te.style.border="1px solid red");const r="UBER2024"===le.value||"uber2024"===le.value||"UBER 2024"===le.value||"uber 2024"===le.value||""===le.value.trim();r?(re.style.display="none",le.style.border="1px solid green"):(re.style.display="block",le.style.border="1px solid red");const s=/^\+380\((50|66|95|99|63|67|68|96|97|98|39|73|93)\)-\d{3}-\d{2}-\d{2}$/.test(se.value)&&""!==se.value.trim();s?(ie.style.display="none",se.style.border="1px solid green"):(ie.style.display="block",se.style.border="1px solid red");!1===[t,o,l,r,s].every((e=>e))?(p.style.visibility="hidden",e.preventDefault()):(e.preventDefault(),G.classList.remove("callback_active"),p.style.visibility="visible",F.classList.remove("cb-overlay_active"),document.body.style.overflow="auto",_e.style.display="none",localStorage.setItem("couponClosed",!0),H.classList.remove("button_active"),ge.classList.add("success_active"),Y.reset(),setTimeout((()=>{ge.classList.remove("success_active")}),7e3))}));let ce=!1;K.addEventListener("input",(()=>{ce=/^[а-яА-Я]{2,}$/.test(K.value)&&""!==K.value.trim(),ce?(Q.style.display="none",K.style.border="1px solid green"):(Q.style.display="block",K.style.border="1px solid red"),ue()}));let ae=!1;X.addEventListener("input",(()=>{ae=/^[а-яА-Я]{3,}$/.test(X.value)&&""!==X.value.trim(),ae?(ee.style.display="none",X.style.border="1px solid green"):(ee.style.display="block",X.style.border="1px solid red"),ue()}));let ne=!1;te.addEventListener("input",(()=>{ne=""!==te.value.trim(),ne?(oe.style.display="none",te.style.border="1px solid green"):(oe.style.display="block",te.style.border="1px solid red"),ue()}));let de=!1;se.addEventListener("input",(()=>{de=/^\+380\((50|66|95|99|63|67|68|96|97|98|39|73|93)\)-\d{3}-\d{2}-\d{2}$/.test(se.value)&&""!==se.value.trim(),de?(ie.style.display="none",se.style.border="1px solid green"):(ie.style.display="block",se.style.border="1px solid red"),ue()}));const ue=()=>{ce&&ae&&ne&&de?R.classList.remove("button_active"):R.classList.add("button_active")};ue();const me=document.querySelector(".advertising__close"),ye=document.querySelector(".advertising"),be=localStorage.getItem("advertisingClosed");me.addEventListener("click",(()=>{localStorage.setItem("advertisingClosed",!0),ye.style.display="none"})),"true"===be&&(ye.style.display="none");const ve=document.querySelector(".coupon__close"),_e=document.querySelector(".coupon"),pe=localStorage.getItem("couponClosed");ve.addEventListener("click",(()=>{localStorage.setItem("couponClosed",!0),_e.style.display="none"})),"true"===pe&&(_e.style.display="none");const ge=document.querySelector(".success");document.querySelector(".success__close").addEventListener("click",(()=>{ge.classList.remove("success_active")}));const ke=document.getElementById("main-header"),Le=document.querySelector(".subheader__logo-link"),Ee=document.getElementById("general"),fe=document.querySelector(".arrow-up"),Se=document.getElementById("footer-up-link"),qe=document.getElementById("main-conditions"),he=document.getElementById("on-your-car"),we=document.getElementById("on-our-car"),Ie=document.querySelector(".advertising__link"),xe=document.getElementById("footer-conditions-link"),Be=document.getElementById("main-require"),De=document.getElementById("require"),Te=document.getElementById("main-geolocation"),Ae=document.getElementById("geolocation"),Ce=document.getElementById("footer-geolocation-link"),Ue=e=>{e.scrollIntoView({behavior:"smooth"})};Ee.addEventListener("click",(e=>{e.preventDefault()})),Le.addEventListener("click",(e=>{e.preventDefault(),Ue(ke)})),fe.addEventListener("click",(e=>{e.preventDefault(),Ue(ke)})),Se.addEventListener("click",(e=>{e.preventDefault(),Ue(ke)})),he.addEventListener("click",(e=>{e.preventDefault(),Ue(qe)})),we.addEventListener("click",(e=>{e.preventDefault(),Ue(qe)})),Ie.addEventListener("click",(e=>{e.preventDefault(),Ue(qe)})),xe.addEventListener("click",(e=>{e.preventDefault(),Ue(qe)})),De.addEventListener("click",(e=>{e.preventDefault(),Ue(Be)})),Ae.addEventListener("click",(e=>{e.preventDefault(),Ue(Te)})),Ce.addEventListener("click",(e=>{e.preventDefault(),Ue(Te)}));const $e=document.querySelector(".decor"),Pe=document.querySelector(".arrow-up"),Ne=document.querySelector(".consultation");document.onscroll=()=>{let e=window.scrollY;e>$e.offsetTop?g.style.top="0px":g.style.top="",e>1200&&(Ne.classList.add("consultation_active"),Pe.classList.add("arrow-up_active"),ye.classList.add("advertising_active")),e<1e3&&Pe.classList.remove("arrow-up_active")};const je=document.querySelectorAll(".consultation__link"),ze=document.querySelector(".button-open-consultation"),Me=document.querySelector(".button-close-consultation");ze.addEventListener("click",(()=>{je.forEach((e=>{e.addEventListener("click",(e=>{e.preventDefault()})),e.classList.toggle("consultation__link_active")})),ze.classList.toggle("button-open-consultation_active"),Me.classList.toggle("button-close-consultation_active")})),Me.addEventListener("click",(()=>{je.forEach((e=>{e.classList.toggle("consultation__link_active")})),ze.classList.toggle("button-open-consultation_active"),Me.classList.toggle("button-close-consultation_active")}));document.querySelector(".css-validator-link").addEventListener("click",(e=>{e.preventDefault()}));const Oe=document.querySelector(".word__link"),Ze=document.querySelector(".word__map");Oe.addEventListener("click",(()=>{Ze.classList.toggle("word__map_active"),Ze.classList.contains("word__map_active")?Oe.innerHTML="РАЗВЕРНУТЬ КАРТУ":Oe.innerHTML="СПРЯТАТЬ КАРТУ"}));document.querySelectorAll(".modal-registration__form-privacy-link").forEach((e=>{e.addEventListener("click",(e=>{e.preventDefault()}))}));document.querySelectorAll(".footer__menu-support-link").forEach((e=>{e.addEventListener("click",(e=>{e.preventDefault()}))}));document.querySelectorAll(".footer__menu-language-link").forEach((e=>{e.addEventListener("click",(e=>{e.preventDefault()}))}))}));
