window.addEventListener("DOMContentLoaded",(()=>{const e=()=>{const e=document.createElement("canvas");return!(!e.getContext||!e.getContext("2d"))&&0===e.toDataURL("image/webp").indexOf("data:image/webp")};e()?document.querySelector(".header").style.backgroundImage="url(assets/img/bg/webp/main_bg-min.webp)":document.querySelector(".header").style.backgroundImage="url(assets/img/bg/main_bg-min.jpg)",e()?document.querySelector(".mobile-block__decor_item-one").style.backgroundImage="url(assets/img/bg/webp/mobile_screen_1-min.webp)":document.querySelector(".mobile-block__decor_item-one").style.backgroundImage="url(assets/img/bg/mobile_screen_1-min.jpg)",e()?document.querySelector(".mobile-block__decor_item-two").style.backgroundImage="url(assets/img/bg/webp/mobile_screen_2-min.webp)":document.querySelector(".mobile-block__decor_item-two").style.backgroundImage="url(assets/img/bg/mobile_screen_2-min.jpg)",e()?document.querySelector(".mobile-block__decor_item-three").style.backgroundImage="url(assets/img/bg/webp/mobile_screen_3-min.webp)":document.querySelector(".mobile-block__decor_item-three").style.backgroundImage="url(assets/img/bg/mobile_screen_3-min.jpg)",e()?document.querySelector(".mobile-block__decor_item-four").style.backgroundImage="url(assets/img/bg/webp/mobile_screen_4-min.webp)":document.querySelector(".mobile-block__decor_item-four").style.backgroundImage="url(assets/img/bg/mobile_screen_4-min.jpg)",e()?document.querySelector(".mobile-block__decor_item-five").style.backgroundImage="url(assets/img/bg/webp/mobile_screen_5-min.webp)":document.querySelector(".mobile-block__decor_item-five").style.backgroundImage="url(assets/img/bg/mobile_screen_5-min.jpg)",e()?document.querySelector(".mobile-block__decor_item-six").style.backgroundImage="url(assets/img/bg/webp/mobile_screen_6-min.webp)":document.querySelector(".mobile-block__decor_item-six").style.backgroundImage="url(assets/img/bg/mobile_screen_6-min.jpg)",e()?document.querySelector(".word").style.backgroundImage="url(assets/img/bg/webp/map-min.webp)":document.querySelector(".word").style.backgroundImage="url(assets/img/bg/map-min.jpg";const t=document.querySelector(".menu"),o=document.querySelectorAll(".menu__items"),l=document.querySelector(".hamburger"),r=document.querySelector(".decor_translucent");l.addEventListener("click",(()=>{l.classList.contains("hamburger_active")?(l.classList.remove("hamburger_active"),document.body.style.overflow="auto",t.classList.remove("menu_active"),l&&r.classList.remove("decor_translucent_active")):(l.classList.add("hamburger_active"),document.body.style.overflow="hidden",t.classList.add("menu_active"),l&&r.classList.add("decor_translucent_active"))})),o.forEach((e=>{e.addEventListener("click",(()=>{l.classList.remove("hamburger_active"),document.body.style.overflow="auto",t.classList.remove("menu_active"),l&&r.classList.remove("decor_translucent_active")}))}));document.querySelectorAll(".mobile-block__wrapper").forEach((e=>{const t=e.querySelector(".mobile-block__image"),o=e.querySelector(".mobile-block__title"),l=e.querySelector(".mobile-block__hiden-title");t.addEventListener("click",(()=>{t&&t.classList.toggle("mobile-block__image_active"),o&&o.classList.toggle("mobile-block__title_active"),l&&l.classList.toggle("mobile-block__hiden-title_active")}))}));const s=document.querySelector(".registration-overflow"),c=document.querySelector(".button_registration"),n=document.querySelector(".button_registration-form"),a=document.querySelectorAll(".modal-registration__header-close"),i=document.querySelector(".button-advertising");c.addEventListener("click",(()=>{s.classList.add("registration-overflow_active"),document.body.style.overflow="hidden",c.classList.add("button_active"),K.classList.remove("advertising_active"),document.addEventListener("keydown",d)})),i.addEventListener("click",(()=>{s.classList.add("registration-overflow_active"),document.body.style.overflow="hidden",c.classList.add("button_active"),K.classList.remove("advertising_active")})),a.forEach((e=>{e.addEventListener("click",(()=>{s.classList.remove("registration-overflow_active"),document.body.style.overflow="auto",c.classList.remove("button_active")}))}));const d=e=>{"Escape"===e.key&&(s.classList.remove("registration-overflow_active"),document.body.style.overflow="auto",c.classList.remove("button_active"))};document.querySelectorAll(".modal-registration__form-privacy-link").forEach((e=>{e.addEventListener("click",(e=>{e.preventDefault()}))}));const u=document.querySelector(".modal-registration__form"),m=document.getElementById("firstName-registration"),y=document.querySelector(".modal-registration__form-error_firstName"),b=document.getElementById("lastName-registration"),v=document.querySelector(".modal-registration__form-error_lastName"),_=document.getElementById("cities-registration"),p=document.querySelector(".modal-registration__form-error_cities"),g=document.getElementById("email-registration"),k=document.querySelector(".modal-registration__form-error_email"),f=document.getElementById("phoneNumber-registration"),E=document.querySelector(".modal-registration__form-error_phoneNumber");IMask(f,{mask:"+{38\\0}(00)-000-00-00"});u.addEventListener("submit",(e=>{const t=/^[а-яА-Я]{2,}$/.test(m.value)&&""!==m.value.trim();t?(y.style.display="none",m.style.border="1px solid green"):(y.style.display="block",m.style.border="1px solid red");const o=/^[а-яА-Я]{3,}$/.test(b.value)&&""!==b.value.trim();o?(v.style.display="none",b.style.border="1px solid green"):(v.style.display="block",b.style.border="1px solid red");const l=""!==_.value.trim();l?(p.style.display="none",_.style.border="1px solid green"):(p.style.display="block",_.style.border="1px solid red");const r=/^[a-zA-Z0-9._%+-]+@(gmail\.com|yahoo\.com|outlook\.com|hotmail\.com|yandex\.ru)$/i.test(g.value)&&""!==g.value.trim();r?(k.style.display="none",g.style.border="1px solid green"):(k.style.display="block",g.style.border="1px solid red");const n=/^\+380\(\d{2}\)-\d{3}-\d{2}-\d{2}$/.test(f.value)&&""!==f.value.trim();n?(E.style.display="none",f.style.border="1px solid green"):(E.style.display="block",f.style.border="1px solid red");!1===[t,o,l,r,n].every((e=>e))?e.preventDefault():(e.preventDefault(),s.classList.remove("registration-overflow_active"),document.body.style.overflow="auto",K.style.display="none",c.classList.remove("button_active"),te.classList.add("success_active"),u.reset(),setTimeout((()=>{te.classList.remove("success_active")}),7e3))}));let q=!1;m.addEventListener("input",(()=>{q=/^[а-яА-Я]{2,}$/.test(m.value)&&""!==m.value.trim(),q?(y.style.display="none",m.style.border="1px solid green"):(y.style.display="block",m.style.border="1px solid red"),I()}));let w=!1;b.addEventListener("input",(()=>{w=/^[а-яА-Я]{3,}$/.test(b.value)&&""!==b.value.trim(),w?(v.style.display="none",b.style.border="1px solid green"):(v.style.display="block",b.style.border="1px solid red"),I()}));let S=!1;_.addEventListener("input",(()=>{S=""!==_.value.trim(),S?(p.style.display="none",_.style.border="1px solid green"):(p.style.display="block",_.style.border="1px solid red"),I()}));let x=!1;f.addEventListener("input",(()=>{x=/^\+380\(\d{2}\)-\d{3}-\d{2}-\d{2}$/.test(f.value)&&""!==f.value.trim(),x?(E.style.display="none",f.style.border="1px solid green"):(E.style.display="block",f.style.border="1px solid red"),I()}));let h=!1;g.addEventListener("input",(()=>{h=/^[a-zA-Z0-9._%+-]+@(gmail\.com|yahoo\.com|outlook\.com|hotmail\.com|yandex\.ru)$/i.test(g.value)&&""!==g.value.trim(),h?(k.style.display="none",g.style.border="1px solid green"):(k.style.display="block",g.style.border="1px solid red"),I()}));const I=()=>{q&&w&&S&&x&&h?n.classList.remove("button_active"):n.classList.add("button_active")};I();const B=document.querySelector(".callback-overflow"),D=document.querySelector(".button_callback"),$=document.querySelector(".button_callback-form"),N=document.querySelectorAll(".modal-callback__header-close");D.addEventListener("click",(()=>{B.classList.add("callback-overflow_active"),document.body.style.overflow="hidden",D.classList.add("button_active"),document.addEventListener("keydown",T)})),N.forEach((e=>{e.addEventListener("click",(()=>{B.classList.remove("callback-overflow_active"),document.body.style.overflow="auto",Q.classList.add("coupon_active"),D.classList.remove("button_active")}))}));const T=e=>{"Escape"===e.key&&(B.classList.remove("callback-overflow_active"),document.body.style.overflow="auto",D.classList.remove("button_active"),Q.classList.add("coupon_active"))};document.querySelectorAll(".modal-callback__form-privacy-link").forEach((e=>{e.addEventListener("click",(e=>{e.preventDefault()}))}));const A=document.querySelector(".modal-callback__form"),P=document.getElementById("firstName-callback"),j=document.querySelector(".modal-callback__form-error_firstName"),z=document.getElementById("lastName-callback"),C=document.querySelector(".modal-callback__form-error_lastName"),M=document.getElementById("cities-callback"),O=document.querySelector(".modal-callback__form-error_cities"),U=document.getElementById("couponCode-callback"),Z=document.querySelector(".modal-callback__form-error_couponCode"),W=document.getElementById("phoneNumber-callback"),H=document.querySelector(".modal-callback__form-error_phoneNumber");IMask(W,{mask:"+{38\\0}(00)-000-00-00"});A.addEventListener("submit",(e=>{const t=/^[а-яА-Я]{2,}$/.test(P.value)&&""!==P.value.trim();t?(j.style.display="none",P.style.border="1px solid green"):(j.style.display="block",P.style.border="1px solid red");const o=/^[а-яА-Я]{3,}$/.test(z.value)&&""!==z.value.trim();o?(C.style.display="none",z.style.border="1px solid green"):(C.style.display="block",z.style.border="1px solid red");const l=""!==M.value.trim();l?(O.style.display="none",M.style.border="1px solid green"):(O.style.display="block",M.style.border="1px solid red");const r="uber2024"===U.value||""===U.value.trim();r?(Z.style.display="none",U.style.border="1px solid green"):(Z.style.display="block",U.style.border="1px solid red");const s=/^\+380\(\d{2}\)-\d{3}-\d{2}-\d{2}$/.test(W.value)&&""!==W.value.trim();s?(H.style.display="none",W.style.border="1px solid green"):(H.style.display="block",W.style.border="1px solid red");!1===[t,o,l,r,s].every((e=>e))?e.preventDefault():(e.preventDefault(),B.classList.remove("callback-overflow_active"),document.body.style.overflow="auto",Q.style.display="none",D.classList.remove("button_active"),te.classList.add("success_active"),A.reset(),setTimeout((()=>{te.classList.remove("success_active")}),7e3))}));let V=!1;P.addEventListener("input",(()=>{V=/^[а-яА-Я]{2,}$/.test(P.value)&&""!==P.value.trim(),V?(j.style.display="none",P.style.border="1px solid green"):(j.style.display="block",P.style.border="1px solid red"),F()}));let G=!1;z.addEventListener("input",(()=>{G=/^[а-яА-Я]{3,}$/.test(z.value)&&""!==z.value.trim(),G?(C.style.display="none",z.style.border="1px solid green"):(C.style.display="block",z.style.border="1px solid red"),F()}));let R=!1;M.addEventListener("input",(()=>{R=""!==M.value.trim(),R?(O.style.display="none",M.style.border="1px solid green"):(O.style.display="block",M.style.border="1px solid red"),F()}));let Y=!1;W.addEventListener("input",(()=>{Y=/^\+380\(\d{2}\)-\d{3}-\d{2}-\d{2}$/.test(W.value)&&""!==W.value.trim(),Y?(H.style.display="none",W.style.border="1px solid green"):(H.style.display="block",W.style.border="1px solid red"),F()}));const F=()=>{V&&G&&R&&Y?$.classList.remove("button_active"):$.classList.add("button_active")};F();const J=document.querySelector(".advertising__close"),K=document.querySelector(".advertising");J.addEventListener("click",(()=>{K.style.display="none"}));const Q=document.querySelector(".coupon"),X=document.querySelector(".coupon__close"),ee=document.querySelector(".coupon__img");X.addEventListener("click",(()=>{Q.style.display="none"})),ee.addEventListener("click",(()=>{B.classList.add("callback-overflow_active"),document.body.style.overflow="hidden",D.classList.add("button_active")}));const te=document.querySelector(".success");document.querySelector(".success__close").addEventListener("click",(()=>{te.classList.remove("success_active")}));const oe=document.getElementById("general"),le=document.querySelector(".arrow-up"),re=document.getElementById("to-header"),se=document.getElementById("on-your-car"),ce=document.getElementById("on-our-car"),ne=document.getElementById("to-conditions"),ae=document.getElementById("require"),ie=document.getElementById("to-require"),de=document.getElementById("geolocation"),ue=document.getElementById("to-geolocation"),me=document.querySelector(".advertising__link"),ye=document.querySelector(".subheader__logo-link"),be=e=>{e.scrollIntoView({behavior:"smooth"})};ye.addEventListener("click",(e=>{e.preventDefault(),be(re)})),oe.addEventListener("click",(e=>{e.preventDefault(),be(re)})),le.addEventListener("click",(e=>{e.preventDefault(),be(re)})),me.addEventListener("click",(e=>{e.preventDefault(),be(ne)})),se.addEventListener("click",(e=>{e.preventDefault(),be(ne)})),ce.addEventListener("click",(e=>{e.preventDefault(),be(ne)})),ae.addEventListener("click",(e=>{e.preventDefault(),be(ie)})),de.addEventListener("click",(e=>{e.preventDefault(),be(ue)}));const ve=document.querySelector(".decor"),_e=document.querySelector(".arrow-up"),pe=document.querySelector(".consultation");document.onscroll=()=>{let e=window.scrollY;e>ve.offsetTop?r.style.top="0px":r.style.top="",e>1200&&(pe.classList.add("consultation_active"),_e.classList.add("arrow-up_active"),K.classList.add("advertising_active")),e<1e3&&_e.classList.remove("arrow-up_active")};const ge=document.querySelectorAll(".consultation__link"),ke=document.querySelector(".button-open-consultation"),Le=document.querySelector(".button-close-consultation");ke.addEventListener("click",(()=>{ge.forEach((e=>{e.addEventListener("click",(e=>{e.preventDefault()})),e.classList.toggle("consultation__link_active")})),ke.classList.toggle("button-open-consultation_active"),Le.classList.toggle("button-close-consultation_active")})),Le.addEventListener("click",(()=>{ge.forEach((e=>{e.classList.toggle("consultation__link_active")})),ke.classList.toggle("button-open-consultation_active"),Le.classList.toggle("button-close-consultation_active")}));document.querySelector(".css-validator-link").addEventListener("click",(e=>{e.preventDefault()}));const fe=document.querySelector(".word__link"),Ee=document.querySelector(".word__map");fe.addEventListener("click",(()=>{Ee.classList.toggle("word__map_active"),Ee.classList.contains("word__map_active")?fe.innerHTML="РАЗВЕРНУТЬ КАРТУ":fe.innerHTML="СПРЯТАТЬ КАРТУ"}));let qe=L.map("map",{scrollWheelZoom:!1,touchZoom:!0}).setView([50.4501,30.5234],13);qe.on("click",(()=>{qe.zoomIn()})),qe.on("contextmenu",(()=>{qe.zoomOut()})),qe.zoomControl.setPosition("topright");let we=L.marker([50.4501,30.5234]).addTo(qe),Se=L.marker([50.4567,30.5198]).addTo(qe),xe=L.marker([50.4592,30.5269]).addTo(qe),he=L.marker([50.4443,30.5261]).addTo(qe);we.bindPopup("<b>Главный официальный филиал Uber в Киеве</b><br>Адрес: ул. Хрещатик, 1, Киев, 01001<br>Время работы: Пн-Вс, 24/7").openPopup(),Se.bindPopup("<b>Офис UberEats в Киеве</b><br>Адрес: бул. Леси Украинки, 10, Киев, 01034<br>Время работы: Пн-Пт: 10:00 - 22:00, Сб-Вс: 12:00 - 20:00").openPopup(),xe.bindPopup("<b>Центр поддержки Uber для водителей</b><br>Адрес: ул. Велика Васильківська, 45, Киев, 02000<br>Время работы: Пн-Пт: 09:00 - 18:00").openPopup(),he.bindPopup("<b>Офис Uber Green в Киеве</b><br>Адрес: просп. Голосеевский, 50, Киев, 03034<br>Время работы: Пн-Пт: 09:00 - 17:00, Сб-Вс: выходной").openPopup(),L.tileLayer("https://tile.openstreetmap.org/{z}/{x}/{y}.png",{maxZoom:19,attribution:'&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>'}).addTo(qe),(new WOW).init()}));
