window.addEventListener("DOMContentLoaded",(()=>{let e=L.map("map",{scrollWheelZoom:!1,touchZoom:!0}).setView([49.0266,31.4832],6);e.on("click",(()=>{e.zoomIn()})),e.on("contextmenu",(()=>{e.zoomOut()})),e.zoomControl.setPosition("topright");let t=L.marker([50.4567,30.5198]).addTo(e),o=L.marker([50.4501,30.5234]).addTo(e),l=L.marker([49.8397,24.0297]).addTo(e),r=L.marker([48.9226,24.7111]).addTo(e),s=L.marker([48.5092,32.2623]).addTo(e),i=L.marker([49.8398,24.0297]).addTo(e),c=L.marker([48.5126,35.0342]).addTo(e),a=L.marker([49.9808,36.2527]).addTo(e),n=L.marker([46.4775,30.7326]).addTo(e),d=L.marker([49.556,25.5906]).addTo(e),u=L.marker([50.8333,34.4844]).addTo(e);t.bindPopup("<b>Главный офис Uber в Киеве</b><br>Адрес: ул. Хрещатик, 1, Киев, 01001<br>Время работы: Пн-Вс, 24/7").openPopup(),o.bindPopup("<b>Филиал UberEats в Киеве</b><br>Адрес: бул. Леси Украинки, 10, Киев, 01034<br>Время работы: Пн-Пт: 10:00 - 22:00, Сб-Вс: 12:00 - 20:00"),l.bindPopup("<b>Филиал  Uber Green в Львове</b><br>Адрес: просп. Свободы, 12, Львов, 79000<br>Время работы: Пн-Вс: 9:00 - 21:00"),r.bindPopup("<b>Филиал Uber Freight в Ивано-Франковске</b><br>Адрес: вул. Грушевського, 7, Ивано-Франковск, 76000<br>Время работы: Пн-Пт: 9:00 - 20:00, Сб: 10:00 - 18:00"),s.bindPopup("<b>Филиал Uber Health в Кропивницком</b><br>Адрес: вул. Київська, 17, Кропивницкий, 25006<br>Время работы: Пн-Вс: 10:00 - 19:00"),i.bindPopup("<b>Филиал Uber в Тернополе</b><br>Адрес: вул. Чорновола, 3, Тернополь, 46001<br>Время работы: Пн-Пт: 9:00 - 18:00"),c.bindPopup("<b>Филиал Uber for Business в Днепре</b><br>Адрес: просп. Слобожанський, 16, Днепр, 49000<br>Время работы: Пн-Вс: 10:00 - 20:00"),a.bindPopup("<b>Филиал Uber Elevate в Харькове</b><br>Адрес: просп. Науки, 24, Харьков, 61000<br>Время работы: Пн-Пт: 9:00 - 21:00, Сб-Вс: 10:00 - 18:00"),n.bindPopup("<b>Филиал Uber Jump в Одессе</b><br>Адрес: вул. Катерининська, 1, Одесса, 65000<br>Время работы: Пн-Вс: 10:00 - 19:00"),d.bindPopup("<b>Филиал  Uber ATG (Advanced Technologies Group) в Хмельницком</b><br>Адрес: вул. Проскурівська, 13, Хмельницкий, 29000<br>Время работы: Пн-Пт: 9:00 - 20:00, Сб: 10:00 - 18:00"),u.bindPopup("<b>Филиал  Uber Air в Полтаве</b><br>Адрес: вул. Шевченка, 23, Полтава, 36000<br>Время работы: Пн-Вс: 10:00 - 19:00"),L.tileLayer("https://tile.openstreetmap.org/{z}/{x}/{y}.png",{maxZoom:19,attribution:'&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>'}).addTo(e),(new WOW).init(),document.body.onload=()=>{const e=document.querySelector(".preloader"),t=document.querySelector(".lang-overlay");document.querySelectorAll(".languages-content__menu-item").forEach((e=>{e.addEventListener("click",(e=>{e.preventDefault(),localStorage.setItem("langChoiceVisited",!0),t.classList.add("lang-overlay_active"),document.body.style.overflow="auto"}))}));const o=localStorage.getItem("langChoiceVisited");e.classList.contains("preloader_active")||(e.classList.add("preloader_active"),document.body.style.overflow="hidden"),"true"===o&&(t.style.display="none",document.body.style.overflow="auto")};const m=()=>{const e=document.createElement("canvas");return!(!e.getContext||!e.getContext("2d"))&&0===e.toDataURL("image/webp").indexOf("data:image/webp")};m()?document.querySelector(".header").style.backgroundImage="url(assets/img/bg/webp/main_bg-min.webp)":document.querySelector(".header").style.backgroundImage="url(assets/img/bg/main_bg-min.jpg)",m()?document.querySelector(".mobile-block__decor_item-one").style.backgroundImage="url(assets/img/bg/webp/mobile_screen_1-min.webp)":document.querySelector(".mobile-block__decor_item-one").style.backgroundImage="url(assets/img/bg/mobile_screen_1-min.jpg)",m()?document.querySelector(".mobile-block__decor_item-two").style.backgroundImage="url(assets/img/bg/webp/mobile_screen_2-min.webp)":document.querySelector(".mobile-block__decor_item-two").style.backgroundImage="url(assets/img/bg/mobile_screen_2-min.jpg)",m()?document.querySelector(".mobile-block__decor_item-three").style.backgroundImage="url(assets/img/bg/webp/mobile_screen_3-min.webp)":document.querySelector(".mobile-block__decor_item-three").style.backgroundImage="url(assets/img/bg/mobile_screen_3-min.jpg)",m()?document.querySelector(".mobile-block__decor_item-four").style.backgroundImage="url(assets/img/bg/webp/mobile_screen_4-min.webp)":document.querySelector(".mobile-block__decor_item-four").style.backgroundImage="url(assets/img/bg/mobile_screen_4-min.jpg)",m()?document.querySelector(".mobile-block__decor_item-five").style.backgroundImage="url(assets/img/bg/webp/mobile_screen_5-min.webp)":document.querySelector(".mobile-block__decor_item-five").style.backgroundImage="url(assets/img/bg/mobile_screen_5-min.jpg)",m()?document.querySelector(".mobile-block__decor_item-six").style.backgroundImage="url(assets/img/bg/webp/mobile_screen_6-min.webp)":document.querySelector(".mobile-block__decor_item-six").style.backgroundImage="url(assets/img/bg/mobile_screen_6-min.jpg)",m()?document.querySelector(".word").style.backgroundImage="url(assets/img/bg/webp/map-min.webp)":document.querySelector(".word").style.backgroundImage="url(assets/img/bg/map-min.jpg";const y=document.querySelector(".menu"),b=document.querySelectorAll(".menu__items"),v=document.querySelector(".hamburger"),_=document.querySelector(".decor_translucent");v.addEventListener("click",(()=>{v.classList.contains("hamburger_active")?(v.classList.remove("hamburger_active"),S.classList.remove("reg-overlay_active"),document.body.style.overflow="auto",y.classList.remove("menu_active"),v&&_.classList.remove("decor_translucent_active")):(v.classList.add("hamburger_active"),S.classList.add("reg-overlay_active"),document.body.style.overflow="hidden",y.classList.add("menu_active"),v&&_.classList.add("decor_translucent_active"))})),b.forEach((e=>{e.addEventListener("click",(()=>{v.classList.remove("hamburger_active"),S.classList.remove("reg-overlay_active"),document.body.style.overflow="auto",y.classList.remove("menu_active"),v&&_.classList.remove("decor_translucent_active")}))}));document.querySelectorAll(".mobile-block__wrapper").forEach((e=>{const t=e.querySelector(".mobile-block__image"),o=e.querySelector(".mobile-block__title"),l=e.querySelector(".mobile-block__hidden-title");t.addEventListener("click",(()=>{t&&t.classList.toggle("mobile-block__image_active"),o&&o.classList.toggle("mobile-block__title_active"),l&&l.classList.toggle("mobile-block__hidden-title_active")}))}));const p=document.querySelector(".registration"),g=document.querySelector(".button_registration"),k=document.querySelector(".button_registration-form"),E=document.querySelectorAll(".modal-registration__header-close"),f=document.querySelector(".button-advertising"),S=document.querySelector(".reg-overlay");g.addEventListener("click",(()=>{S.classList.add("reg-overlay_active"),v.style.visibility="hidden",p.classList.add("registration_active"),document.body.style.overflow="hidden",g.classList.add("button_active"),ue.classList.remove("advertising_active"),document.addEventListener("keydown",q)})),f.addEventListener("click",(()=>{S.classList.add("reg-overlay_active"),v.style.visibility="hidden",p.classList.add("registration_active"),document.body.style.overflow="hidden",g.classList.add("button_active"),ue.classList.remove("advertising_active"),document.addEventListener("keydown",q)})),E.forEach((e=>{e.addEventListener("click",(()=>{S.classList.remove("reg-overlay_active"),v.style.visibility="visible",p.classList.remove("registration_active"),document.body.style.overflow="auto",g.classList.remove("button_active")}))}));const q=e=>{"Escape"===e.key&&(S.classList.remove("reg-overlay_active"),v.style.visibility="visible",p.classList.remove("registration_active"),document.body.style.overflow="auto",g.classList.remove("button_active"))},h=document.querySelector(".modal-registration__form"),w=document.getElementById("firstName-registration"),I=document.querySelector(".modal-registration__form-error_firstName"),x=document.getElementById("lastName-registration"),B=document.querySelector(".modal-registration__form-error_lastName"),D=document.getElementById("cities-registration"),T=document.querySelector(".modal-registration__form-error_cities"),A=document.getElementById("email-registration"),C=document.querySelector(".modal-registration__form-error_email"),U=document.getElementById("phoneNumber-registration"),$=document.querySelector(".modal-registration__form-error_phoneNumber");IMask(U,{mask:"+{38\\0}(00)-000-00-00"});h.addEventListener("submit",(e=>{const t=/^[а-яА-Я]{2,}$/.test(w.value)&&""!==w.value.trim();t?(I.style.display="none",w.style.border="1px solid green"):(I.style.display="block",w.style.border="1px solid red");const o=/^[а-яА-Я]{3,}$/.test(x.value)&&""!==x.value.trim();o?(B.style.display="none",x.style.border="1px solid green"):(B.style.display="block",x.style.border="1px solid red");const l=""!==D.value.trim();l?(T.style.display="none",D.style.border="1px solid green"):(T.style.display="block",D.style.border="1px solid red");const r=/^[a-zA-Z0-9._%+-]+@(gmail\.com|yahoo\.com|outlook\.com|hotmail\.com|yandex\.ru)$/i.test(A.value)&&""!==A.value.trim();r?(C.style.display="none",A.style.border="1px solid green"):(C.style.display="block",A.style.border="1px solid red");const s=/^\+380\((50|66|95|99|63|67|68|96|97|98|39|73|93)\)-\d{3}-\d{2}-\d{2}$/.test(U.value)&&""!==U.value.trim();s?($.style.display="none",U.style.border="1px solid green"):($.style.display="block",U.style.border="1px solid red");!1===[t,o,l,r,s].every((e=>e))?(v.style.visibility="hidden",e.preventDefault()):(e.preventDefault(),p.classList.remove("registration_active"),v.style.visibility="visible",S.classList.remove("reg-overlay_active"),document.body.style.overflow="auto",ue.style.display="none",localStorage.setItem("advertisingClosed",!0),g.classList.remove("button_active"),_e.classList.add("success_active"),h.reset(),setTimeout((()=>{_e.classList.remove("success_active")}),7e3))}));let P=!1;w.addEventListener("input",(()=>{P=/^[а-яА-Я]{2,}$/.test(w.value)&&""!==w.value.trim(),P?(I.style.display="none",w.style.border="1px solid green"):(I.style.display="block",w.style.border="1px solid red"),O()}));let N=!1;x.addEventListener("input",(()=>{N=/^[а-яА-Я]{3,}$/.test(x.value)&&""!==x.value.trim(),N?(B.style.display="none",x.style.border="1px solid green"):(B.style.display="block",x.style.border="1px solid red"),O()}));let j=!1;D.addEventListener("input",(()=>{j=""!==D.value.trim(),j?(T.style.display="none",D.style.border="1px solid green"):(T.style.display="block",D.style.border="1px solid red"),O()}));let z=!1;U.addEventListener("input",(()=>{z=/^\+380\((50|66|95|99|63|67|68|96|97|98|39|73|93)\)-\d{3}-\d{2}-\d{2}$/.test(U.value)&&""!==U.value.trim(),z?($.style.display="none",U.style.border="1px solid green"):($.style.display="block",U.style.border="1px solid red"),O()}));let M=!1;A.addEventListener("input",(()=>{M=/^[a-zA-Z0-9._%+-]+@(gmail\.com|yahoo\.com|outlook\.com|hotmail\.com|yandex\.ru)$/i.test(A.value)&&""!==A.value.trim(),M?(C.style.display="none",A.style.border="1px solid green"):(C.style.display="block",A.style.border="1px solid red"),O()}));const O=()=>{P&&N&&j&&z&&M?k.classList.remove("button_active"):k.classList.add("button_active")};O();const Z=document.querySelector(".callback"),V=document.querySelector(".button_callback"),G=document.querySelector(".button_callback-form"),H=document.querySelectorAll(".modal-callback__header-close"),R=document.querySelector(".cb-overlay");V.addEventListener("click",(()=>{R.classList.add("cb-overlay_active"),v.style.visibility="hidden",Z.classList.add("callback_active"),document.body.style.overflow="hidden",V.classList.add("button_active"),document.addEventListener("keydown",W)}));document.querySelector(".coupon__img").addEventListener("click",(()=>{R.classList.add("cb-overlay_active"),v.style.visibility="hidden",Z.classList.add("callback_active"),document.body.style.overflow="hidden",V.classList.add("button_active")})),H.forEach((e=>{e.addEventListener("click",(()=>{R.classList.remove("cb-overlay_active"),v.style.visibility="visible",Z.classList.remove("callback_active"),document.body.style.overflow="auto",be.classList.add("coupon_active"),V.classList.remove("button_active")}))}));const W=e=>{"Escape"===e.key&&(R.classList.remove("cb-overlay_active"),v.style.visibility="visible",Z.classList.remove("callback_active"),document.body.style.overflow="auto",V.classList.remove("button_active"),be.classList.add("coupon_active"))};document.querySelectorAll(".modal-callback__form-privacy-link").forEach((e=>{e.addEventListener("click",(e=>{e.preventDefault()}))}));const F=document.querySelector(".modal-callback__form"),J=document.getElementById("firstName-callback"),Y=document.querySelector(".modal-callback__form-error_firstName"),K=document.getElementById("lastName-callback"),Q=document.querySelector(".modal-callback__form-error_lastName"),X=document.getElementById("cities-callback"),ee=document.querySelector(".modal-callback__form-error_cities"),te=document.getElementById("couponCode-callback"),oe=document.querySelector(".modal-callback__form-error_couponCode"),le=document.getElementById("phoneNumber-callback"),re=document.querySelector(".modal-callback__form-error_phoneNumber");IMask(le,{mask:"+{38\\0}(00)-000-00-00"});F.addEventListener("submit",(e=>{const t=/^[а-яА-Я]{2,}$/.test(J.value)&&""!==J.value.trim();t?(Y.style.display="none",J.style.border="1px solid green"):(Y.style.display="block",J.style.border="1px solid red");const o=/^[а-яА-Я]{3,}$/.test(K.value)&&""!==K.value.trim();o?(Q.style.display="none",K.style.border="1px solid green"):(Q.style.display="block",K.style.border="1px solid red");const l=""!==X.value.trim();l?(ee.style.display="none",X.style.border="1px solid green"):(ee.style.display="block",X.style.border="1px solid red");const r="UBER2024"===te.value||"uber2024"===te.value||"UBER 2024"===te.value||"uber 2024"===te.value||""===te.value.trim();r?(oe.style.display="none",te.style.border="1px solid green"):(oe.style.display="block",te.style.border="1px solid red");const s=/^\+380\((50|66|95|99|63|67|68|96|97|98|39|73|93)\)-\d{3}-\d{2}-\d{2}$/.test(le.value)&&""!==le.value.trim();s?(re.style.display="none",le.style.border="1px solid green"):(re.style.display="block",le.style.border="1px solid red");!1===[t,o,l,r,s].every((e=>e))?(v.style.visibility="hidden",e.preventDefault()):(e.preventDefault(),Z.classList.remove("callback_active"),v.style.visibility="visible",R.classList.remove("cb-overlay_active"),document.body.style.overflow="auto",be.style.display="none",localStorage.setItem("couponClosed",!0),V.classList.remove("button_active"),_e.classList.add("success_active"),F.reset(),setTimeout((()=>{_e.classList.remove("success_active")}),7e3))}));let se=!1;J.addEventListener("input",(()=>{se=/^[а-яА-Я]{2,}$/.test(J.value)&&""!==J.value.trim(),se?(Y.style.display="none",J.style.border="1px solid green"):(Y.style.display="block",J.style.border="1px solid red"),ne()}));let ie=!1;K.addEventListener("input",(()=>{ie=/^[а-яА-Я]{3,}$/.test(K.value)&&""!==K.value.trim(),ie?(Q.style.display="none",K.style.border="1px solid green"):(Q.style.display="block",K.style.border="1px solid red"),ne()}));let ce=!1;X.addEventListener("input",(()=>{ce=""!==X.value.trim(),ce?(ee.style.display="none",X.style.border="1px solid green"):(ee.style.display="block",X.style.border="1px solid red"),ne()}));let ae=!1;le.addEventListener("input",(()=>{ae=/^\+380\((50|66|95|99|63|67|68|96|97|98|39|73|93)\)-\d{3}-\d{2}-\d{2}$/.test(le.value)&&""!==le.value.trim(),ae?(re.style.display="none",le.style.border="1px solid green"):(re.style.display="block",le.style.border="1px solid red"),ne()}));const ne=()=>{se&&ie&&ce&&ae?G.classList.remove("button_active"):G.classList.add("button_active")};ne();const de=document.querySelector(".advertising__close"),ue=document.querySelector(".advertising"),me=localStorage.getItem("advertisingClosed");de.addEventListener("click",(()=>{localStorage.setItem("advertisingClosed",!0),ue.style.display="none"})),"true"===me&&(ue.style.display="none");const ye=document.querySelector(".coupon__close"),be=document.querySelector(".coupon"),ve=localStorage.getItem("couponClosed");ye.addEventListener("click",(()=>{localStorage.setItem("couponClosed",!0),be.style.display="none"})),"true"===ve&&(be.style.display="none");const _e=document.querySelector(".success");document.querySelector(".success__close").addEventListener("click",(()=>{_e.classList.remove("success_active")}));const pe=document.getElementById("main-header"),ge=document.querySelector(".subheader__logo-link"),ke=document.getElementById("general"),Le=document.querySelector(".arrow-up"),Ee=document.getElementById("footer-up-link"),fe=document.getElementById("main-conditions"),Se=document.getElementById("on-your-car"),qe=document.getElementById("on-our-car"),he=document.querySelector(".advertising__link"),we=document.getElementById("footer-conditions-link"),Ie=document.getElementById("main-require"),xe=document.getElementById("require"),Be=document.getElementById("main-geolocation"),De=document.getElementById("geolocation"),Te=document.getElementById("footer-geolocation-link"),Ae=e=>{e.scrollIntoView({behavior:"smooth"})};ke.addEventListener("click",(e=>{e.preventDefault()})),ge.addEventListener("click",(e=>{e.preventDefault(),Ae(pe)})),Le.addEventListener("click",(e=>{e.preventDefault(),Ae(pe)})),Ee.addEventListener("click",(e=>{e.preventDefault(),Ae(pe)})),Se.addEventListener("click",(e=>{e.preventDefault(),Ae(fe)})),qe.addEventListener("click",(e=>{e.preventDefault(),Ae(fe)})),he.addEventListener("click",(e=>{e.preventDefault(),Ae(fe)})),we.addEventListener("click",(e=>{e.preventDefault(),Ae(fe)})),xe.addEventListener("click",(e=>{e.preventDefault(),Ae(Ie)})),De.addEventListener("click",(e=>{e.preventDefault(),Ae(Be)})),Te.addEventListener("click",(e=>{e.preventDefault(),Ae(Be)}));const Ce=document.querySelector(".decor"),Ue=document.querySelector(".arrow-up"),$e=document.querySelector(".consultation");document.onscroll=()=>{let e=window.scrollY;e>Ce.offsetTop?_.style.top="0px":_.style.top="",e>1200&&($e.classList.add("consultation_active"),Ue.classList.add("arrow-up_active"),ue.classList.add("advertising_active")),e<1e3&&Ue.classList.remove("arrow-up_active")};const Pe=document.querySelectorAll(".consultation__link"),Ne=document.querySelector(".button-open-consultation"),je=document.querySelector(".button-close-consultation");Ne.addEventListener("click",(()=>{Pe.forEach((e=>{e.addEventListener("click",(e=>{e.preventDefault()})),e.classList.toggle("consultation__link_active")})),Ne.classList.toggle("button-open-consultation_active"),je.classList.toggle("button-close-consultation_active")})),je.addEventListener("click",(()=>{Pe.forEach((e=>{e.classList.toggle("consultation__link_active")})),Ne.classList.toggle("button-open-consultation_active"),je.classList.toggle("button-close-consultation_active")}));document.querySelector(".css-validator-link").addEventListener("click",(e=>{e.preventDefault()}));const ze=document.querySelector(".word__link"),Me=document.querySelector(".word__map");ze.addEventListener("click",(()=>{Me.classList.toggle("word__map_active"),Me.classList.contains("word__map_active")?ze.innerHTML="РАЗВЕРНУТЬ КАРТУ":ze.innerHTML="СПРЯТАТЬ КАРТУ"}));document.querySelectorAll(".modal-registration__form-privacy-link").forEach((e=>{e.addEventListener("click",(e=>{e.preventDefault()}))}));document.querySelectorAll(".footer__menu-support-link").forEach((e=>{e.addEventListener("click",(e=>{e.preventDefault()}))}));document.querySelectorAll(".footer__menu-language-link").forEach((e=>{e.addEventListener("click",(e=>{e.preventDefault()}))}))}));
