window.addEventListener("DOMContentLoaded",(()=>{const e=document.querySelector(".preloader");document.body.onload=()=>{const o=localStorage.getItem("langChoiceVisited");e.classList.contains("preloader_active")||(e.classList.add("preloader_active"),localStorage.setItem("langChoiceVisited",!0),document.body.style.overflow="hidden"),"true"===o&&(t.style.display="none",document.body.style.overflow="auto")};const t=document.querySelector(".choice-languages");document.querySelectorAll(".choice-languages__items-link").forEach((e=>{e.addEventListener("click",(()=>{t.classList.add("choice-languages_active"),document.body.style.overflow="auto"}))}));const o=()=>{const e=document.createElement("canvas");return!(!e.getContext||!e.getContext("2d"))&&0===e.toDataURL("image/webp").indexOf("data:image/webp")};o()?document.querySelector(".header").style.backgroundImage="url(assets/img/bg/webp/main_bg-min.webp)":document.querySelector(".header").style.backgroundImage="url(assets/img/bg/main_bg-min.jpg)",o()?document.querySelector(".mobile-block__decor_item-one").style.backgroundImage="url(assets/img/bg/webp/mobile_screen_1-min.webp)":document.querySelector(".mobile-block__decor_item-one").style.backgroundImage="url(assets/img/bg/mobile_screen_1-min.jpg)",o()?document.querySelector(".mobile-block__decor_item-two").style.backgroundImage="url(assets/img/bg/webp/mobile_screen_2-min.webp)":document.querySelector(".mobile-block__decor_item-two").style.backgroundImage="url(assets/img/bg/mobile_screen_2-min.jpg)",o()?document.querySelector(".mobile-block__decor_item-three").style.backgroundImage="url(assets/img/bg/webp/mobile_screen_3-min.webp)":document.querySelector(".mobile-block__decor_item-three").style.backgroundImage="url(assets/img/bg/mobile_screen_3-min.jpg)",o()?document.querySelector(".mobile-block__decor_item-four").style.backgroundImage="url(assets/img/bg/webp/mobile_screen_4-min.webp)":document.querySelector(".mobile-block__decor_item-four").style.backgroundImage="url(assets/img/bg/mobile_screen_4-min.jpg)",o()?document.querySelector(".mobile-block__decor_item-five").style.backgroundImage="url(assets/img/bg/webp/mobile_screen_5-min.webp)":document.querySelector(".mobile-block__decor_item-five").style.backgroundImage="url(assets/img/bg/mobile_screen_5-min.jpg)",o()?document.querySelector(".mobile-block__decor_item-six").style.backgroundImage="url(assets/img/bg/webp/mobile_screen_6-min.webp)":document.querySelector(".mobile-block__decor_item-six").style.backgroundImage="url(assets/img/bg/mobile_screen_6-min.jpg)",o()?document.querySelector(".word").style.backgroundImage="url(assets/img/bg/webp/map-min.webp)":document.querySelector(".word").style.backgroundImage="url(assets/img/bg/map-min.jpg";const l=document.querySelector(".menu"),s=document.querySelectorAll(".menu__items"),r=document.querySelector(".hamburger"),c=document.querySelector(".decor_translucent");r.addEventListener("click",(()=>{r.classList.contains("hamburger_active")?(r.classList.remove("hamburger_active"),m.classList.remove("reg-overlay_active"),document.body.style.overflow="auto",l.classList.remove("menu_active"),r&&c.classList.remove("decor_translucent_active")):(r.classList.add("hamburger_active"),m.classList.add("reg-overlay_active"),document.body.style.overflow="hidden",l.classList.add("menu_active"),r&&c.classList.add("decor_translucent_active"))})),s.forEach((e=>{e.addEventListener("click",(()=>{r.classList.remove("hamburger_active"),m.classList.remove("reg-overlay_active"),document.body.style.overflow="auto",l.classList.remove("menu_active"),r&&c.classList.remove("decor_translucent_active")}))}));document.querySelectorAll(".mobile-block__wrapper").forEach((e=>{const t=e.querySelector(".mobile-block__image"),o=e.querySelector(".mobile-block__title"),l=e.querySelector(".mobile-block__hidden-title");t.addEventListener("click",(()=>{t&&t.classList.toggle("mobile-block__image_active"),o&&o.classList.toggle("mobile-block__title_active"),l&&l.classList.toggle("mobile-block__hidden-title_active")}))}));const i=document.querySelector(".registration"),a=document.querySelector(".button_registration"),d=document.querySelector(".button_registration-form"),n=document.querySelectorAll(".modal-registration__header-close"),u=document.querySelector(".button-advertising"),m=document.querySelector(".reg-overlay");a.addEventListener("click",(()=>{m.classList.add("reg-overlay_active"),r.style.visibility="hidden",i.classList.add("registration_active"),document.body.style.overflow="hidden",a.classList.add("button_active"),te.classList.remove("advertising_active"),document.addEventListener("keydown",b)})),u.addEventListener("click",(()=>{m.classList.add("reg-overlay_active"),r.style.visibility="hidden",i.classList.add("registration_active"),document.body.style.overflow="hidden",a.classList.add("button_active"),te.classList.remove("advertising_active"),document.addEventListener("keydown",b)})),n.forEach((e=>{e.addEventListener("click",(()=>{m.classList.remove("reg-overlay_active"),r.style.visibility="visible",i.classList.remove("registration_active"),document.body.style.overflow="auto",a.classList.remove("button_active")}))}));const b=e=>{"Escape"===e.key&&(m.classList.remove("reg-overlay_active"),r.style.visibility="visible",i.classList.remove("registration_active"),document.body.style.overflow="auto",a.classList.remove("button_active"))};document.querySelectorAll(".modal-registration__form-privacy-link").forEach((e=>{e.addEventListener("click",(e=>{e.preventDefault()}))}));const y=document.querySelector(".modal-registration__form"),v=document.getElementById("firstName-registration"),_=document.querySelector(".modal-registration__form-error_firstName"),g=document.getElementById("lastName-registration"),p=document.querySelector(".modal-registration__form-error_lastName"),k=document.getElementById("cities-registration"),S=document.querySelector(".modal-registration__form-error_cities"),E=document.getElementById("email-registration"),q=document.querySelector(".modal-registration__form-error_email"),f=document.getElementById("phoneNumber-registration"),h=document.querySelector(".modal-registration__form-error_phoneNumber");IMask(f,{mask:"+{38\\0}(00)-000-00-00"});y.addEventListener("submit",(e=>{const t=/^[а-яА-Я]{2,}$/.test(v.value)&&""!==v.value.trim();t?(_.style.display="none",v.style.border="1px solid green"):(_.style.display="block",v.style.border="1px solid red");const o=/^[а-яА-Я]{3,}$/.test(g.value)&&""!==g.value.trim();o?(p.style.display="none",g.style.border="1px solid green"):(p.style.display="block",g.style.border="1px solid red");const l=""!==k.value.trim();l?(S.style.display="none",k.style.border="1px solid green"):(S.style.display="block",k.style.border="1px solid red");const s=/^[a-zA-Z0-9._%+-]+@(gmail\.com|yahoo\.com|outlook\.com|hotmail\.com|yandex\.ru)$/i.test(E.value)&&""!==E.value.trim();s?(q.style.display="none",E.style.border="1px solid green"):(q.style.display="block",E.style.border="1px solid red");const c=/^\+380\((50|66|95|99|63|67|68|96|97|98|39|73|93)\)-\d{3}-\d{2}-\d{2}$/.test(f.value)&&""!==f.value.trim();c?(h.style.display="none",f.style.border="1px solid green"):(h.style.display="block",f.style.border="1px solid red");!1===[t,o,l,s,c].every((e=>e))?(r.style.visibility="hidden",e.preventDefault()):(e.preventDefault(),i.classList.remove("registration_active"),r.style.visibility="visible",m.classList.remove("reg-overlay_active"),document.body.style.overflow="auto",te.style.display="none",localStorage.setItem("advertisingClosed",!0),a.classList.remove("button_active"),ce.classList.add("success_active"),y.reset(),setTimeout((()=>{ce.classList.remove("success_active")}),7e3))}));let w=!1;v.addEventListener("input",(()=>{w=/^[а-яА-Я]{2,}$/.test(v.value)&&""!==v.value.trim(),w?(_.style.display="none",v.style.border="1px solid green"):(_.style.display="block",v.style.border="1px solid red"),D()}));let x=!1;g.addEventListener("input",(()=>{x=/^[а-яА-Я]{3,}$/.test(g.value)&&""!==g.value.trim(),x?(p.style.display="none",g.style.border="1px solid green"):(p.style.display="block",g.style.border="1px solid red"),D()}));let I=!1;k.addEventListener("input",(()=>{I=""!==k.value.trim(),I?(S.style.display="none",k.style.border="1px solid green"):(S.style.display="block",k.style.border="1px solid red"),D()}));let B=!1;f.addEventListener("input",(()=>{B=/^\+380\((50|66|95|99|63|67|68|96|97|98|39|73|93)\)-\d{3}-\d{2}-\d{2}$/.test(f.value)&&""!==f.value.trim(),B?(h.style.display="none",f.style.border="1px solid green"):(h.style.display="block",f.style.border="1px solid red"),D()}));let T=!1;E.addEventListener("input",(()=>{T=/^[a-zA-Z0-9._%+-]+@(gmail\.com|yahoo\.com|outlook\.com|hotmail\.com|yandex\.ru)$/i.test(E.value)&&""!==E.value.trim(),T?(q.style.display="none",E.style.border="1px solid green"):(q.style.display="block",E.style.border="1px solid red"),D()}));const D=()=>{w&&x&&I&&B&&T?d.classList.remove("button_active"):d.classList.add("button_active")};D();const C=document.querySelector(".callback"),$=document.querySelector(".button_callback"),A=document.querySelector(".button_callback-form"),P=document.querySelectorAll(".modal-callback__header-close"),N=document.querySelector(".cb-overlay");$.addEventListener("click",(()=>{N.classList.add("cb-overlay_active"),r.style.visibility="hidden",C.classList.add("callback_active"),document.body.style.overflow="hidden",$.classList.add("button_active"),document.addEventListener("keydown",U)}));document.querySelector(".coupon__img").addEventListener("click",(()=>{N.classList.add("cb-overlay_active"),r.style.visibility="hidden",C.classList.add("callback_active"),document.body.style.overflow="hidden",$.classList.add("button_active")})),P.forEach((e=>{e.addEventListener("click",(()=>{N.classList.remove("cb-overlay_active"),r.style.visibility="visible",C.classList.remove("callback_active"),document.body.style.overflow="auto",se.classList.add("coupon_active"),$.classList.remove("button_active")}))}));const U=e=>{"Escape"===e.key&&(N.classList.remove("cb-overlay_active"),r.style.visibility="visible",C.classList.remove("callback_active"),document.body.style.overflow="auto",$.classList.remove("button_active"),se.classList.add("coupon_active"))};document.querySelectorAll(".modal-callback__form-privacy-link").forEach((e=>{e.addEventListener("click",(e=>{e.preventDefault()}))}));const j=document.querySelector(".modal-callback__form"),z=document.getElementById("firstName-callback"),M=document.querySelector(".modal-callback__form-error_firstName"),O=document.getElementById("lastName-callback"),Z=document.querySelector(".modal-callback__form-error_lastName"),V=document.getElementById("cities-callback"),G=document.querySelector(".modal-callback__form-error_cities"),H=document.getElementById("couponCode-callback"),W=document.querySelector(".modal-callback__form-error_couponCode"),F=document.getElementById("phoneNumber-callback"),J=document.querySelector(".modal-callback__form-error_phoneNumber");IMask(F,{mask:"+{38\\0}(00)-000-00-00"});j.addEventListener("submit",(e=>{const t=/^[а-яА-Я]{2,}$/.test(z.value)&&""!==z.value.trim();t?(M.style.display="none",z.style.border="1px solid green"):(M.style.display="block",z.style.border="1px solid red");const o=/^[а-яА-Я]{3,}$/.test(O.value)&&""!==O.value.trim();o?(Z.style.display="none",O.style.border="1px solid green"):(Z.style.display="block",O.style.border="1px solid red");const l=""!==V.value.trim();l?(G.style.display="none",V.style.border="1px solid green"):(G.style.display="block",V.style.border="1px solid red");const s="uber2024"===H.value||""===H.value.trim();s?(W.style.display="none",H.style.border="1px solid green"):(W.style.display="block",H.style.border="1px solid red");const c=/^\+380\((50|66|95|99|63|67|68|96|97|98|39|73|93)\)-\d{3}-\d{2}-\d{2}$/.test(F.value)&&""!==F.value.trim();c?(J.style.display="none",F.style.border="1px solid green"):(J.style.display="block",F.style.border="1px solid red");!1===[t,o,l,s,c].every((e=>e))?(r.style.visibility="hidden",e.preventDefault()):(e.preventDefault(),C.classList.remove("callback_active"),r.style.visibility="visible",N.classList.remove("cb-overlay_active"),document.body.style.overflow="auto",se.style.display="none",localStorage.setItem("couponClosed",!0),$.classList.remove("button_active"),ce.classList.add("success_active"),j.reset(),setTimeout((()=>{ce.classList.remove("success_active")}),7e3))}));let R=!1;z.addEventListener("input",(()=>{R=/^[а-яА-Я]{2,}$/.test(z.value)&&""!==z.value.trim(),R?(M.style.display="none",z.style.border="1px solid green"):(M.style.display="block",z.style.border="1px solid red"),X()}));let Y=!1;O.addEventListener("input",(()=>{Y=/^[а-яА-Я]{3,}$/.test(O.value)&&""!==O.value.trim(),Y?(Z.style.display="none",O.style.border="1px solid green"):(Z.style.display="block",O.style.border="1px solid red"),X()}));let K=!1;V.addEventListener("input",(()=>{K=""!==V.value.trim(),K?(G.style.display="none",V.style.border="1px solid green"):(G.style.display="block",V.style.border="1px solid red"),X()}));let Q=!1;F.addEventListener("input",(()=>{Q=/^\+380\((50|66|95|99|63|67|68|96|97|98|39|73|93)\)-\d{3}-\d{2}-\d{2}$/.test(F.value)&&""!==F.value.trim(),Q?(J.style.display="none",F.style.border="1px solid green"):(J.style.display="block",F.style.border="1px solid red"),X()}));const X=()=>{R&&Y&&K&&Q?A.classList.remove("button_active"):A.classList.add("button_active")};X();const ee=document.querySelector(".advertising__close"),te=document.querySelector(".advertising"),oe=localStorage.getItem("advertisingClosed");ee.addEventListener("click",(()=>{localStorage.setItem("advertisingClosed",!0),te.style.display="none"})),"true"===oe&&(te.style.display="none");const le=document.querySelector(".coupon__close"),se=document.querySelector(".coupon"),re=localStorage.getItem("couponClosed");le.addEventListener("click",(()=>{localStorage.setItem("couponClosed",!0),se.style.display="none"})),"true"===re&&(se.style.display="none");const ce=document.querySelector(".success");document.querySelector(".success__close").addEventListener("click",(()=>{ce.classList.remove("success_active")}));const ie=document.getElementById("general"),ae=document.querySelector(".arrow-up"),de=document.getElementById("to-header"),ne=document.getElementById("on-your-car"),ue=document.getElementById("on-our-car"),me=document.getElementById("to-conditions"),be=document.getElementById("require"),ye=document.getElementById("to-require"),ve=document.getElementById("geolocation"),_e=document.getElementById("to-geolocation"),ge=document.querySelector(".advertising__link"),pe=document.querySelector(".subheader__logo-link"),ke=e=>{e.scrollIntoView({behavior:"smooth"})};pe.addEventListener("click",(e=>{e.preventDefault(),ke(de)})),ie.addEventListener("click",(e=>{e.preventDefault(),ke(de)})),ae.addEventListener("click",(e=>{e.preventDefault(),ke(de)})),ge.addEventListener("click",(e=>{e.preventDefault(),ke(me)})),ne.addEventListener("click",(e=>{e.preventDefault(),ke(me)})),ue.addEventListener("click",(e=>{e.preventDefault(),ke(me)})),be.addEventListener("click",(e=>{e.preventDefault(),ke(ye)})),ve.addEventListener("click",(e=>{e.preventDefault(),ke(_e)}));const Le=document.querySelector(".decor"),Se=document.querySelector(".arrow-up"),Ee=document.querySelector(".consultation");document.onscroll=()=>{let e=window.scrollY;e>Le.offsetTop?c.style.top="0px":c.style.top="",e>1200&&(Ee.classList.add("consultation_active"),Se.classList.add("arrow-up_active"),te.classList.add("advertising_active")),e<1e3&&Se.classList.remove("arrow-up_active")};const qe=document.querySelectorAll(".consultation__link"),fe=document.querySelector(".button-open-consultation"),he=document.querySelector(".button-close-consultation");fe.addEventListener("click",(()=>{qe.forEach((e=>{e.addEventListener("click",(e=>{e.preventDefault()})),e.classList.toggle("consultation__link_active")})),fe.classList.toggle("button-open-consultation_active"),he.classList.toggle("button-close-consultation_active")})),he.addEventListener("click",(()=>{qe.forEach((e=>{e.classList.toggle("consultation__link_active")})),fe.classList.toggle("button-open-consultation_active"),he.classList.toggle("button-close-consultation_active")}));document.querySelector(".css-validator-link").addEventListener("click",(e=>{e.preventDefault()}));const we=document.querySelector(".word__link"),xe=document.querySelector(".word__map");we.addEventListener("click",(()=>{xe.classList.toggle("word__map_active"),xe.classList.contains("word__map_active")?we.innerHTML="РАЗВЕРНУТЬ КАРТУ":we.innerHTML="СПРЯТАТЬ КАРТУ"}));let Ie=L.map("map",{scrollWheelZoom:!1,touchZoom:!0}).setView([49.0266,31.4832],6);Ie.on("click",(()=>{Ie.zoomIn()})),Ie.on("contextmenu",(()=>{Ie.zoomOut()})),Ie.zoomControl.setPosition("topright");let Be=L.marker([50.4567,30.5198]).addTo(Ie),Te=L.marker([50.4501,30.5234]).addTo(Ie),De=L.marker([49.8397,24.0297]).addTo(Ie),Ce=L.marker([48.9226,24.7111]).addTo(Ie),$e=L.marker([48.5092,32.2623]).addTo(Ie),Ae=L.marker([49.8398,24.0297]).addTo(Ie),Pe=L.marker([48.5126,35.0342]).addTo(Ie),Ne=L.marker([49.9808,36.2527]).addTo(Ie),Ue=L.marker([46.4775,30.7326]).addTo(Ie),je=L.marker([49.556,25.5906]).addTo(Ie),ze=L.marker([50.8333,34.4844]).addTo(Ie);Be.bindPopup("<b>Главный офис Uber в Киеве</b><br>Адрес: ул. Хрещатик, 1, Киев, 01001<br>Время работы: Пн-Вс, 24/7").openPopup(),Te.bindPopup("<b>Филиал UberEats в Киеве</b><br>Адрес: бул. Леси Украинки, 10, Киев, 01034<br>Время работы: Пн-Пт: 10:00 - 22:00, Сб-Вс: 12:00 - 20:00"),De.bindPopup("<b>Филиал  Uber Green в Львове</b><br>Адрес: просп. Свободы, 12, Львов, 79000<br>Время работы: Пн-Вс: 9:00 - 21:00"),Ce.bindPopup("<b>Филиал Uber Freight в Ивано-Франковске</b><br>Адрес: вул. Грушевського, 7, Ивано-Франковск, 76000<br>Время работы: Пн-Пт: 9:00 - 20:00, Сб: 10:00 - 18:00"),$e.bindPopup("<b>Филиал Uber Health в Кропивницком</b><br>Адрес: вул. Київська, 17, Кропивницкий, 25006<br>Время работы: Пн-Вс: 10:00 - 19:00"),Ae.bindPopup("<b>Филиал Uber в Тернополе</b><br>Адрес: вул. Чорновола, 3, Тернополь, 46001<br>Время работы: Пн-Пт: 9:00 - 18:00"),Pe.bindPopup("<b>Филиал Uber for Business в Днепре</b><br>Адрес: просп. Слобожанський, 16, Днепр, 49000<br>Время работы: Пн-Вс: 10:00 - 20:00"),Ne.bindPopup("<b>Филиал Uber Elevate в Харькове</b><br>Адрес: просп. Науки, 24, Харьков, 61000<br>Время работы: Пн-Пт: 9:00 - 21:00, Сб-Вс: 10:00 - 18:00"),Ue.bindPopup("<b>Филиал Uber Jump в Одессе</b><br>Адрес: вул. Катерининська, 1, Одесса, 65000<br>Время работы: Пн-Вс: 10:00 - 19:00"),je.bindPopup("<b>Филиал  Uber ATG (Advanced Technologies Group) в Хмельницком</b><br>Адрес: вул. Проскурівська, 13, Хмельницкий, 29000<br>Время работы: Пн-Пт: 9:00 - 20:00, Сб: 10:00 - 18:00"),ze.bindPopup("<b>Филиал  Uber Air в Полтаве</b><br>Адрес: вул. Шевченка, 23, Полтава, 36000<br>Время работы: Пн-Вс: 10:00 - 19:00"),L.tileLayer("https://tile.openstreetmap.org/{z}/{x}/{y}.png",{maxZoom:19,attribution:'&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>'}).addTo(Ie),(new WOW).init()}));
